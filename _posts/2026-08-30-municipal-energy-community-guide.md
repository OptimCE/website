...
faq:
  ...
  - q: "Does joining an energy community require a public procurement procedure?"
    a: "Three operations are routinely confused. Buying the photovoltaic installation is a public contract for supplies and works, subject to the usual rules: it is by far the heaviest part, and it is what dictates the timetable. Setting up the legal entity and the municipality's participation in it fall under the Walloon Code of local democracy and decentralisation, which means a council resolution and administrative supervision, not procurement law. The sharing agreement between participants is not a contract award at all: it is an agreement on how a produced volume is allocated, at a price freely set between participants. The exact classification depends on the arrangement chosen and deserves to be validated by the municipality's legal department or by the Union of Walloon Cities and Municipalities before the resolution is passed, not after."
  - q: "Can the public welfare centre join the municipality's energy community?"
    a: "Yes. The public welfare centre is covered by the list of local authorities restored by the Walloon Government decree of 5 February 2026, which entered into force on 26 February 2026. It was already covered before the Council of State annulled that list in March 2025, and it is covered again now. Be careful, however, not to confuse two very different things: bringing in the welfare centre as an institution, with its own buildings and its own meters, is simple and has no perverse effect. Bringing households that benefit from the social tariff into the allocation key is another matter, because those households lose the benefit of the social tariff on the kilowatt-hours allocated to them through sharing. They keep it on what they continue to buy from their supplier, but not on the shared share. The arithmetic therefore has to be done household by household before they are signed up."
  - q: "Which legal form should a municipal energy community take?"
    a: "Walloon law imposes none: it requires a distinct legal personality, autonomy, effective control by nearby participants, and a purpose of environmental, economic or social benefits rather than profit. In practice, the thirteen energy communities registered with the CWaPE as of 3 September 2026 are all non-profit associations, without exception — including the five whose name as displayed by the regulator carries no such label, and whose form can be checked in the Crossroads Bank for Enterprises. The non-profit form requires no capital, its disinterested purpose matches the non-profit condition, and its governance is light to run. The cooperative company becomes attractive when the project wants to raise citizen capital and remunerate shares, and the autonomous municipal utility when the municipality wants to operate an asset alone. The Aubange best-practice sheet notes that the non-profit form was chosen there with the possibility of moving later to a cooperative: starting light does not preclude growing."
  - q: "Does sharing between two municipal buildings qualify for the 80 % network tariff reduction?"
    a: "No, and this is the most frequent disappointment. The 80 % reduction on the proportional term of the network tariff, identified under globalisation codes E216 in distribution and E526 in transmission, is reserved for energy sharing within one and the same building. Two distinct municipal buildings — the school and the sports hall, the town hall and the works depot — do not form one same building: sharing between them falls under an energy community, and no tariff reduction applies. The shared kilowatt-hours therefore bear the full network charges, excise duties, federal levies and VAT, exactly like kilowatt-hours bought from a supplier. The only component on which sharing creates value is the energy component. That is real, but it is bounded, and it is better said to the executive before the resolution than after."
  - q: "How long does it take from the council decision to the first shared kilowatt-hour?"
    a: "Count in years rather than months, and the bottleneck is almost never the regulator. The CWaPE has ten working days to confirm that a notification file is complete, and an incomplete file can be completed within six months; those deadlines are short. What takes time is everything upstream: deciding the perimeter and the participants, having the council approve the creation of the legal entity, running the public procurement for the photovoltaic installation, having it installed and connected, obtaining the communicating meters, then obtaining the sharing authorisation and signing the agreement with the network operator. The City of Aubange, the first in Wallonia, had its sharing activity authorised on 11 July 2024, after preparatory work carried out with the Gaume Nature Park and the non-profit Energie Commune. The realistic timetable is that of an ordinary municipal investment, not that of an administrative formality."
---

Wallonia has **262 municipalities**. As of 3 September 2026, the CWaPE lists **thirteen energy communities** whose file has been declared complete — and **only six of them** hold at least one authorised sharing activity. Seven have a legal entity, articles of association, an acknowledgement of receipt, and not a single shared kilowatt-hour.
...
<img src="/assets/images/diagrams/municipal-energy-community-perimeter-en.svg"
     alt="Comparison of the two proximity criteria that define the perimeter of a renewable energy community in Wallonia. On the left, the first criterion: every generation installation whose electricity is shared and every participant in the sharing sit within one single and same municipal territory. The diagram shows a municipal boundary containing a school fitted with photovoltaic panels, a sports hall, a public welfare centre building, the town hall and private homes. The municipality has nothing to demonstrate: it points at its own map, and the administrative boundary serves as the legal perimeter, with no check needed from the network operator. On the right, the second criterion: all connection points of participants and of generation installations must sit downstream of the same high-voltage substation of the local transmission network operator, assessed at the time of the authorisation request. The diagram shows an electrical tree starting from a high-voltage substation and branching towards three groups of connection points, plus a fourth detached group located in the same municipality but connected to a different substation, and therefore excluded. This second criterion appears on no public map: it requires a check with the network operator and can cut a street in two. A band at the bottom of the diagram recalls that the two criteria are alternative, that satisfying one is enough, and that Wallonia is the only one of the three Belgian regions where the legislator drew the perimeter itself rather than leaving members to define it in their own articles of association."
...
| **Brussels** (Brugel) | The members themselves, in the articles of association (article 28*tredecies* of the electricity ordinance); activities take place on the regional territory; the Brugel authorisation runs for 10 renewable years | It **justifies** its perimeter |
...
The law imposes no legal form. Practice, on the other hand, has not wavered: **thirteen registered communities, thirteen non-profit associations.** Zero cooperatives, zero companies, zero utilities.

The CWaPE's table is not enough to establish it, and that is the trap for anyone who wants to check: five of the thirteen names it displays carry no such label — *Soleil de Rixensart*, *Communauté d'énergie partagée by BEP*, *WattLabs*, *Polaris Énergie Renouvelable* and *CER CERTY+*. The absence of the label from a working name says nothing about the actual form: in the Crossroads Bank for Enterprises, those five are registered as non-profit associations, exactly like the other eight.
...
1. **The legal perimeter of a Walloon renewable energy community is, as a first option, the municipal territory.** Every other project developer must demonstrate that they hang off the same high-voltage substation; a municipality points at its own map. Wallonia is the only one of the three regions where the legislator drew the perimeter itself.

2. **Municipal property generates when it is empty.** Schools in July-August, the town hall at weekends, the sports hall all day long: the mismatch between generation and occupancy is structural. The worse the building's profile, the more value sharing has to create.

3. **The legal framework is repaired, and broader than before.** Judgment no. 262,782 of 28 March 2025 had annulled the list of local authorities, leaving only the municipality itself eligible. The decree of 5 February 2026, in force since 26 February 2026, restored and extended it. Welfare centres, provinces, inter-municipal companies and autonomous municipal utilities are eligible again.

4. **Thirteen Walloon communities, thirteen non-profit associations.** The law imposes nothing; practice has decided. The cooperative is justified for raising citizen capital, the autonomous municipal utility for operating alone — and nothing prevents starting as a non-profit and switching later, as Aubange has planned.

5. **Bring in the welfare centre's buildings, not the social-tariff households.** The latter lose the social tariff on shared kilowatt-hours: the most obvious social target is the one demanding the most care in the allocation key.

6. **It is the climate action that needs no subsidy.** The investment is the roof, which the municipality will install anyway for its own building. The energy community only decides the fate of the surplus. Given the state of the POLLEC drawing right and of local finances in 2026, that is an argument, not a fallback.

7. **What not to expect from it:** the energy community does not pay for the roof. On the Aubange figures, it brings in around €310 of additional annual revenue on a €71,390 installation. No network tariff reduction applies to sharing within a community — the 80 % is reserved for the same building — and shared kilowatt-hours bear the full network charges, excise duties and VAT. The real return is measured in residents' pockets, not in the municipal budget.

> ### Set up your municipality's energy community with OptimCE
>
> Open-source platform built for Belgian energy communities: members, meters, allocation keys and sharing operations in one place — right down to simulating the volume your municipal buildings will actually absorb within the quarter-hour, before it goes to the executive.
>
...
The law imposes none: it requires a distinct legal personality, autonomy, effective control by nearby participants and a non-profit purpose. In practice, the thirteen communities registered with the CWaPE as of 3 September 2026 are all non-profit associations — including the five whose name as displayed by the regulator carries no such label, and whose form the Crossroads Bank for Enterprises confirms.
...
- [CWaPE — Energy communities](https://www.cwape.be/secteur/communautes-partage-energie) — source of the table of notified energy communities whose file has been declared complete, thirteen as of 3 September 2026, with their names and their acknowledgement dates; the table paginates at ten rows by default, so the length selector has to be set to one hundred to see all thirteen, and its “Energy sharing” column lags behind the decisions the CWaPE itself has published — see the next entry; also the source of the conditions applying to renewable and citizen energy communities (distinct legal personality, effective control by nearby participants, autonomy, purpose of environmental, economic or social benefits), of the move of the forms to `monespace.wallonie.be` since 25 June 2026, of the ten-working-day deadline for the completeness confirmation, of the six-month deadline to complete a file, and of the annual reporting deadline of 1 September. Accessed on 3 September 2026.
- [CWaPE — Published decisions: authorised energy sharing activities](https://www.cwape.be/documents-recents) — source of the count of communities holding at least one authorised sharing activity: **six out of thirteen** as of 3 September 2026, namely *Soleil d'Aubange (CERSA)*, *ES2*, *Énergie Libre*, *LASNENERGIE*, *Energy For All (CEFA)* and *United Wallonie*. The count is based on the published decisions and not on the “Energy sharing” column of the table of notified communities, which lists only five: decision CD-26c26-CWaPE-1249 of 26 March 2026, published on 13 April 2026, authorises the activity “CEC United Wallonie-Partage n° 1” for the community the table still calls by its former name *uni BE 1*. Register browsed page by page on 4 September 2026.
- [FPS Economy — Crossroads Bank for Enterprises, Public Search](https://kbopub.economie.fgov.be/kbopub/zoeknaamfonetischform.html?lang=en) — source of the actual legal form of the thirteen energy communities in the CWaPE table, all registered under the legal form “non-profit association”. Five of them carry no such label in the name displayed by the regulator: *Soleil de Rixensart* (no. 1040.072.701, non-profit association since 8 July 2026), *Communauté d'énergie partagée by BEP* (no. 1027.241.579, since 4 September 2025), *WattLabs* (no. 1027.867.923, since 19 September 2025), *Polaris Énergie Renouvelable* (no. 1011.695.053, since 17 July 2024) and *CER CERTY+*, registered as “Communauté d'Energie Renouvelable CERTY + à Tournai” (no. 0757.672.542, since 30 October 2020). The *uni BE 1* row of the table corresponds to non-profit association no. 1020.146.228, renamed “Communauté d'énergie citoyenne United Wallonie” on 5 February 2026: it can only be found by ticking the search on previous names. Accessed on 4 September 2026.
- [CWaPE — Energy sharing](https://www.cwape.be/node/5618) — source of the fifteen-minute simultaneity principle, of the existence of a list of standard allocation keys automatically accepted by the network operator, and of the standard agreement concluded between the sharing representative and each Walloon distribution system operator. Accessed on 30 August 2026.
- [CWaPE — Opinion CD-25j10-CWaPE-0965 of 10 October 2025 on the draft decree amending the AGW of 17 March 2023](https://www.cwape.be/sites/default/files/cwape-documents/2025.10.10-0965-Avis%20sur%20AGW%20modificatif%20AGW%20CE%20et%20partage%20d'%C3%A9nergie%20-%20d%C3%A9finition%20autorit%C3%A9s%20locales.pdf) — primary source of the exact reference of the Council of State judgment (no. 262,782 of 28 March 2025) and of its subject matter, of the chronology of the corrective draft (ministerial letter of 17 September 2025, request received on 23 September, urgency sought on a five-working-day basis), of the CWaPE's finding that urgency could not be justified since the request came more than five months after the judgment, and of the categories added to the list of local authorities, including inter-municipal companies made up solely of German-speaking municipalities and autonomous municipal utilities located in the German-speaking region.
- [CWaPE — Evaluation report on the framework for energy communities, energy sharing and self-consumption, 20 February 2025](https://www.cwape.be/sites/default/files/cwape-documents/2025.02.20-0109-Rapport%20%C3%A9valuation%20CE%20et%20partage.pdf) — source of the numerical starting point (three energy communities and a very small number of sharing operations in February 2025) and of the identification of the obstacles to the scheme's development, including the loss of the social tariff on shared volumes and the complexity of the procedures.
- [CWaPE — Are network charges payable in the case of energy sharing?](https://www.cwape.be/node/6062) — source of the 80 % reduction of the proportional term reserved for sharing within one and the same building, of globalisation codes E216 in distribution and E526 in transmission, and of the absence of any reduction for sharing organised within an energy community. Accessed on 30 August 2026.
- [Walloon public service — Questions on energy communities: what is proximity?](https://energie.wallonie.be/home/les-marches-et-les-acteurs/communautes-d-energie/faq/questions-relatives-aux-communautes-d-energie.html) — source of the two alternative proximity criteria applying to a renewable energy community: the territory of one single and same municipality, or downstream of the same high-voltage substation of the local transmission network operator, assessed at the time of the authorisation request. Accessed on 30 August 2026.
- [Walloon public service — Energy sharing and energy community facilitators](https://energie.wallonie.be/home/contacts/facilitateurs-energie/facilitateurs-partage-d-energie-et-communautes-d-energie.html) — source of the existence of a regional facilitator answering free of charge, to public and private project developers alike, and providing tailored legal or technical advice. Accessed on 30 August 2026.
- [Walloon public service — POLLEC, local energy and climate policy](https://energie.wallonie.be/home/au-quotidien/dans-la-commune/pollec---politique-locale-energie-climat.html) — source of the programme's history since 2012, of its coordination by APERe with the support of the Walloon Air and Climate Agency and of the Union of Walloon Cities and Municipalities, of Wallonia's role as regional coordinator of the Covenant of Mayors since 2017, and of the nature of the support provided (energy-climate coordinator, external support for drawing up the plan). Accessed on 30 August 2026.
- [Union of Walloon Cities and Municipalities — The Covenant of Mayors](https://www.uvcw.be/energie/focus/art-2312) — source of the count of 230 Walloon cities and municipalities that had signed by mid-September 2024, of the objective of reducing greenhouse gas emissions by at least 55 % by 2030 for signatories since 2021, and of the two-year deadline to submit the climate action plan after the council's decision to join. Accessed on 30 August 2026.
- [Union of Walloon Cities and Municipalities — Energy communities: the Walloon Government widens the notion of “local authority” following a Council of State judgment](https://www.uvcw.be/energie/actus/art-9974) — source of the entry into force of the Walloon Government decree of 5 February 2026, set at 26 February 2026, and of the content of the restored list: interregional inter-municipal companies, inter-municipal companies made up solely of German-speaking municipalities, autonomous municipal utilities in the German-speaking region, legal persons controlled by those entities, and a ministerial authorisation. Accessed on 30 August 2026.
- [Union of Walloon Cities and Municipalities — Partial annulment of the Walloon Government decree of 17 March 2023 on energy communities and energy sharing](https://www.uvcw.be/energie/actus/art-9455) — source of the identity of the applicant before the Council of State (the interregional cooperative company Vivaqua), of the ground of annulment (restriction to inter-municipal companies falling under the Walloon Region, held contrary to European law and authorised neither by the special law of 8 August 1980 nor by the cooperation agreement of 13 February 2014), of the absence of maintenance of effects, and of the practical consequence that only municipalities, designated directly by the electricity decree, remained eligible as local authorities. Accessed on 30 August 2026.
- [Union of Walloon Cities and Municipalities — Aubange: a best practice for creating a municipal renewable energy community](https://www.uvcw.be/energie/bonnes-pratiques/art-9641) — best-practice sheet published on 1 May 2025 noting that the City of Aubange has been, since 2024, the first in Wallonia to be part of a renewable energy community. Accessed on 30 August 2026.
- [Union of Walloon Cities and Municipalities — The European Energy Communities Facility: financial support for emerging energy communities](https://www.uvcw.be/energie/actus/art-10156) — source of the €45,000 flat grant, of its scope (business model, governance, legal structuring, financial strategy and operational organisation, excluding hardware investment), of the eligibility conditions open to Walloon municipalities, and of the 2026 call closing date of 5 July 2026. Accessed on 30 August 2026.
- [Réseau wallon PAC — Best-practice sheet: Soleil d'Aubange, the first renewable energy community in Wallonia](https://reseauwallonpac.be/system/files/2026-03/Fiche%20BP_CER%20Soleil%20d'Aubange.pdf) — source of all the Aubange figures: municipal photovoltaic installation of 45.36 kWp on the roofs of the works depot, generation of about 41 MWh per year of which 70 % self-consumed, investment of €71,390 including VAT self-financed by the municipality, estimated payback of seven years, a non-profit association bringing together the City and six founding citizen members, an initiative of the Gaume Nature Park and the Pays de Gaume local action group with technical and legal support from Energie Commune, the explicit challenge of fiscal and administrative integration (VAT, excise duties, sharing agreements), and the planned possibility of a later move to a cooperative.
- [CWaPE — Energy sharing activity authorised for the renewable energy community Soleil d'Aubange (CERSA)](https://www.cwape.be/documents-recents/activite-de-partage-denergie-autorisee-pour-la-communaute-denergie-renouvelable) — source of the date on which Wallonia's first sharing activity was authorised, 11 July 2024, on the territory of the City of Aubange. Accessed on 30 August 2026.
- [GAL Condruses — Mapping of energy communities in Wallonia](https://www.galcondruses.be/blog/energie-6/cartographie-des-communautes-denergie-en-wallonie-112) — source of the order of magnitude of the number of participants in Walloon energy communities, about 126 as of 17 June 2026, and of the Brussels comparison point of 1,417 participants. The count of communities used by that mapping differs from the CWaPE's, whose methodology and update date govern in this article. Accessed on 30 August 2026.
- [TWEED — Carbon neutrality decree adopted on 24 October 2023, in force on 1 January 2024](https://clusters.wallonie.be/tweed/fr/news/decret-neutralite-carbone-ete-adopte-ce-2410-au-parlement-entree-en-vigueur-010124) — source of the adoption and entry into force dates of the decree, of the anchoring of the −55 % by 2030 and carbon neutrality by 2050 targets, and of the update of the Air Climate Energy Plan. Accessed on 30 August 2026.
- [Union of Walloon Cities and Municipalities — Draft carbon neutrality decree: the Union's opinion](https://www.uvcw.be/energie/actus/art-8206) — source of the planned evolution of the POLLEC calls for projects towards a drawing right, of its optional character to be activated by the Government, and of the minimum funding of one climate action plan coordinator per municipality or association of municipalities. Accessed on 30 August 2026.
- [Union of Walloon Cities and Municipalities — The Union reacts to the savings measures of the 2026 Walloon budget conclave](https://www.uvcw.be/finances/actus/art-9781) — source of the budgetary context of Walloon local authorities in 2026 and of the Union's public warning about the losses borne by cities and municipalities. Accessed on 30 August 2026.
- [Brugel — Interpretation guide on authorisations granted to energy communities](https://brugel.brussels/publication/document/brochures/2023/fr/Guide_Autorisation_communautes_energie.pdf) — source of the Brussels regime: absence of a legal definition of proximity, referral by article 28*tredecies* of the electricity ordinance to the criteria members set in their articles of association, exercise of the activities on the regional territory, and authorisation granted by Brugel for ten renewable years.
- [Fluvius — Renewable energy community](https://www.fluvius.be/nl/thema/zonnepanelen/delen-en-verkopen-van-energie/hernieuwbare-energiegemeenschap) — source of the Flemish regime: perimeter defined on the basis of technical or geographical proximity in the light of the community's objectives and activities, requirement of legal personality, registration with the Crossroads Bank for Enterprises and registration with the VREG within thirty days of incorporation. Accessed on 30 August 2026.
- [Test-Achats — Survey of injection tariffs, 28 May 2026](https://www.test-achats.be/famille-prive/energie) — source of the range of injection tariffs applied in Belgium, from 0.94 to 4.90 c€/kWh depending on the supplier, used here to stay consistent with our articles on solar surplus and internal transfer pricing. Accessed on 30 August 2026.
