...
| Anlage 7 — Gesellschaften und Vereinigungen | — | PDF |
...
| Dokument | CWaPE-Nummer | Format |
|---|---|---|
| Formular zur Stromteilung | 5609 | PDF |
| Leitfaden zum Formular zur Stromteilung | 5610 | PDF |
| Anlage 6 — Liste der Teilnehmer und der Erzeugungsanlagen | 5611 | Excel |
| Anlage 6bis — Ehrenwörtliche Erklärung, Speicheranlage | 6578 | PDF |
| Anlage 8 — Ehrenwörtliche Erklärung der an der Teilung Beteiligten | 5612 | PDF |
| Änderungsformular zur Stromteilung | 6018 | PDF |
| Leitfaden zum Änderungsformular | 6017 | PDF |
| Anlage 2 — Liste der Teilnehmer und/oder Anlagen (Änderung) | 6019 | Excel |
| Anlage 3 — Ehrenwörtliche Erklärung neuer Teilnehmer | 6020 | PDF |
| Anlage 3bis — Ehrenwörtliche Erklärung, Speicher (Änderung) | 6579 | PDF |
...
Der Gewinn liegt nicht dort, wo man ihn erwartet. Teuer ist nicht das Ausfüllen der Formulare, sondern der Abgleich zwischen drei Teilnehmerlisten und die nachträgliche Rekonstruktion dessen, was übermittelt wurde. Beginnen Sie damit, Mitglieder und Lieferstellen zusammenzuführen; die Dokumente ergeben sich daraus. Der nächste logische Schritt ist die Abrechnung, beschrieben in [„Abrechnung einer Energiegemeinschaft“](/de/aktuelles/2026/07/16/energiegemeinschaft-abrechnung-optimce/), die auf denselben Aufteilungsdaten beruht.

## Das Wichtigste in Kürze

1. **Vier Fristen prägen das Verwaltungsleben einer wallonischen Gemeinschaft**: 10 Werktage für die Vollständigkeitsprüfung, 6 Monate bis zum Verfall eines unvollständigen Dossiers, 15 Werktage zur Meldung einer Änderung und der 1. September für den Jahresbericht.
2. **Die sechs Monate laufen ab der ersten Empfangsbestätigung**, nicht ab dem letzten Austausch. Es ist ein Verfallsdatum, keine Bearbeitungsfrist.
3. **Der Jahresbericht ist ein festes Datum, kein Jahrestag.** Eine im März für vollständig erklärte Gemeinschaft berichtet zum darauffolgenden 1. September.
4. **Seit dem 25. Juni 2026 ist der Wechsel zu Mon Espace nur teilweise vollzogen**: Was an die CWaPE geht, ist digitalisiert; was an den Netzbetreiber geht, bleibt eine herunterzuladende und zu unterzeichnende Datei.
5. **OptimCE bereitet elf Dokumente aus den unveränderten amtlichen Dateien vor** — eingereicht wird das Dokument der Regulierungsbehörde, keine Nachbildung — und lässt die Felder änderbar, die es nicht ableiten kann.
6. **Nichts wird überschrieben**: Status werden an ein Journal angehängt, übermittelte Fassungen bleiben, wie sie waren, und Mitglieder können sehen, was über sie gemeldet wurde und wann.
7. **Einreichung und Unterschrift bleiben Ihre Aufgabe**, und die Abdeckung ist heute wallonisch.
