...
Die CWaPE betreibt **CompaCWaPE**, einen kostenlosen und unabhängigen Vergleichsrechner, der die Jahresrechnung auf Grundlage der Tarifblätter des laufenden Monats ermittelt, für sämtliche in der Wallonischen Region tätigen Lieferanten, die ihre Angebote der Regulierungsbehörde melden ([CWaPE](https://www.cwape.be/consommateurs/compacwape)). Das Werkzeug steht unter [compacwape.be](https://www.compacwape.be/) bereit, und Sie können dort Ihren tatsächlichen Verbrauch statt eines Standardprofils eingeben — nehmen Sie die Zahl aus Ihrer letzten Jahresabrechnung, das Ergebnis fällt völlig anders aus.

Die Größenordnung des Gewinns: Für einen Musterhaushalt mit 3.500 kWh kann die Spanne zwischen dem günstigsten und dem teuersten Angebot „200 € pro Jahr übersteigen“ ([I am Beezy](https://blog.iambeezy.app/fr/prix-electricite-belgique-comparatif-5-fournisseurs-kwh-be-2026/), Mai 2026).
...
Die CWaPE stellt unter [tarifimpact.be](https://www.tarifimpact.be/) einen Simulator und einen Eignungstest bereit. Der Wechsel wird **bei Ihrem Lieferanten** beantragt, nicht beim Netzbetreiber.
...
Zur Automatisierung fördert Wallonien Steuerungstechnik über die **Hausautomationsprämie**, die **40 % der förderfähigen Ausgaben mit einer Obergrenze von 400 €** abdeckt, für Systeme zur intelligenten Messung und Steuerung von Energie ([SPW Économie](https://economie.wallonie.be/demandes/3890_beneficier-d-une-prime-pour-l-installation-d-equipements-de-domotique.html)). Prüfen Sie vor dem Kauf, ob die Geräte auf der Liste der förderfähigen Ausrüstung des SPW stehen.
...
Die derzeitige Regelung der Wohnungsprämien ist eine **befristete Förderregelung vom 14. Februar 2025 bis zum 30. September 2026**. Sämtliche Anträge — Audit wie Arbeiten, **Schlussrechnung eingeschlossen** — müssen bis zu diesem Datum eingereicht werden ([SPW Logement](https://logement.wallonie.be/fr/aide/primes-habitation-2025)).
...
Der Öffentliche Dienst der Wallonie betreibt **16 Anlaufstellen in der gesamten Region und ein Team von 40 Beratern**, in Wallonisch-Brabant, im Hennegau, in Lüttich, Luxemburg und Namur ([SPW Énergie](https://energie.wallonie.be/home/contacts/guichets-energie-wallonie.html)). Die technische Beratung dort ist **persönlich, neutral und vollständig kostenlos**.
...
>
> Eine Open-Source-Plattform für belgische Energiegemeinschaften: Mitglieder, Zähler, Aufteilungsschlüssel und Teilungsoperationen an einem Ort — bis hin zur Erstellung von Rechnungen, Gutschriften und Abrechnungen als PDF aus Ihren offiziellen Aufteilungsdaten.
>
...
- [ORES — Impact, ein neuer Tarif für flexible Verbraucher](https://www.ores.be/comprendre-ma-facture/impact) — drei Zeitbänder, Zugangsbedingungen, optionaler Charakter sowie ein Einsparbeispiel von 224 € für eine flexible Familie gegenüber dem Eintarif.
- [ORES — Photovoltaikanlagen mit Inbetriebnahme vor dem 1. Januar 2024](https://www.ores.be/particulier/compensation-avant-0101) — automatische Kompensation bis zum 31. Dezember 2030, pauschaler oder proportionaler Tarif je nach Zähler und automatische Anwendung der günstigeren Formel.
- [SPW Logement — Wohnungsprämien, befristete Förderregelung 14.02.2025 – 30.09.2026](https://logement.wallonie.be/fr/aide/primes-habitation-2025) — Antragsfrist, Rolle des Wohnungsaudits und davon befreite Arbeiten.
- [SPW Économie — Prämie für die Installation von Hausautomationsgeräten](https://economie.wallonie.be/demandes/3890_beneficier-d-une-prime-pour-l-installation-d-equipements-de-domotique.html) — 40 % der förderfähigen Ausgaben, gedeckelt auf 400 €, für Geräte zur intelligenten Messung und Steuerung von Energie.
- [SPW Énergie — Energieschalter der Wallonie](https://energie.wallonie.be/home/contacts/guichets-energie-wallonie.html) — 16 Anlaufstellen und 40 Berater, persönliche, neutrale und vollständig kostenlose technische Beratung, grüne Nummer 1718.
- [I am Beezy — Strompreise in Belgien 2026: fünf Lieferanten im Vergleich](https://blog.iambeezy.app/fr/prix-electricite-belgique-comparatif-5-fournisseurs-kwh-be-2026/) — Spanne zwischen den Angeboten von über 200 € pro Jahr bei einem Profil von 3.500 kWh (Mai 2026).
- [Énergie Commune — Stromteilung, bewährte Praxis von Interreg Europe](https://www.interregeurope.eu/sites/default/files/good_practices/8.%20EnergieCommune_EC_BM_Sharing_Interreg_Ghent.pdf) — bezifferter Realfall: rund 145 € Jahresersparnis für 500 geteilte kWh zum Standardtarif, rund 70 € zum Sozialtarif, und etwa 6 Jahre Amortisationszeit für die geteilte Anlage.
