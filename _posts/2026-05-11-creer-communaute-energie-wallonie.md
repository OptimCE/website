...
En Wallonie, deux modèles coexistent et sont régis par la [CWaPE](https://www.cwape.be/secteur/communautes-partage-energie), le régulateur wallon de l'énergie : la **Communauté d'Énergie Renouvelable (CER)** et la **Communauté d'Énergie Citoyenne (CEC)**. Le choix conditionne la suite : sources d'énergie admises, périmètre géographique, type d'activités.
...
Pour aller plus loin, la page de référence de la CWaPE détaille le [cadre wallon, les types de communautés et les bases légales](https://www.cwape.be/node/158) issus du décret du 5 mai 2022 et de l'arrêté du Gouvernement wallon du 17 mars 2023.

## Étape 2 — Cadrer le projet et désigner un représentant

C'est l'étape la plus longue, mais aussi celle qui détermine la solidité de la communauté. Avant tout dépôt à la CWaPE, vous devez **structurer le projet** en répondant aux quatre questions clés mises en avant par le [MaCER / Cluster TWEED](https://macer.clustertweed.be/etapes) :
...
Plus rarement, une fondation ou une intercommunale peut porter la communauté. Le choix dépend de **qui investit, qui décide et comment les bénéfices reviennent aux membres**. Le guide [« Comment mettre en place une communauté d'énergie en Wallonie »](https://energieplus-lesite.be/webinaire/comment-mettre-en-place-une-communaute-denergie-en-wallonie/) d'Énergie+ détaille les arbitrages.
...
En Wallonie, **la notification préalable à la CWaPE est obligatoire** : aucune activité de partage ne peut commencer tant que la communauté n'est pas dûment notifiée. La procédure est décrite sur la [page « Quelle est la procédure à suivre pour créer une communauté d'énergie ? »](https://www.cwape.be/node/6052) du régulateur.
...
La CWaPE dispose de **10 jours ouvrables** pour vous délivrer un **accusé de réception** après le dépôt de votre notification (source : [CWaPE — procédure](https://www.cwape.be/node/6052)). Ce délai est court, mais il est strict : **vous ne pouvez pas démarrer le partage d'énergie avant d'avoir reçu cet accusé**.
...
Une fois l'accusé de réception en poche, le partage devient une **opération technique** pilotée par le GRD. La page [ORES — « Démarrer une communauté d'énergie (CER/CEC) »](https://www.ores.be/particulier/demarrer-partage-cer-cec) et le guide [AIEG — « Le partage d'énergie »](https://www.aieg.be/le-partage-denergie) décrivent la mécanique côté gestionnaire.
...
Une fois la communauté en marche, les obligations ne disparaissent pas. La CWaPE impose un **rapportage annuel** détaillant l'activité de la communauté : membres, énergie produite, énergie partagée, évolution de la clé de répartition (voir la [page de référence CWaPE](https://www.cwape.be/node/158)).
...
- [CWaPE — Quelle est la procédure à suivre pour créer une communauté d'énergie ?](https://www.cwape.be/node/6052) — notification obligatoire, formulaire-type, délai de 10 jours ouvrables pour l'accusé de réception.
- [CWaPE — Communautés d'énergie](https://www.cwape.be/node/158) — cadre wallon, types de communautés, bases légales, notification et rapportage annuel.
- [CWaPE — Communautés d'énergie et partage d'énergie](https://www.cwape.be/secteur/communautes-partage-energie) — cadre général wallon du partage et des communautés.
- [ORES — Démarrer une communauté d'énergie (CER/CEC)](https://www.ores.be/particulier/demarrer-partage-cer-cec) — démarches côté gestionnaire de réseau et étapes de lancement.
- [AIEG — Le partage d'énergie](https://www.aieg.be/le-partage-denergie) — aspect opérationnel et mise en place côté GRD.
- [MaCER / Cluster TWEED — Les étapes-clés](https://macer.clustertweed.be/etapes) — accompagnement pour structurer un projet de communauté d'énergie.
- [Énergie+ — Réglementation : Les communautés d'énergie en Wallonie](https://energieplus-lesite.be/reglementations/electricite-et-production-energetique/reglementation-les-communautes-denergie-en-wallonie/) — cadre réglementaire wallon vulgarisé.
- [Énergie+ — Comment mettre en place une communauté d'énergie en Wallonie ?](https://energieplus-lesite.be/webinaire/comment-mettre-en-place-une-communaute-denergie-en-wallonie/) — étapes de création expliquées.
