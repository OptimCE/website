...
Toetreden tot een bestaande gemeenschap is een veel korter traject dan er een oprichten. Het verschil in één oogopslag:

| Aspect | Toetreden | Oprichten |
|---|---|---|
| Typische doorlooptijd | 6 tot 12 weken | 3 tot 6 maanden |
| Juridisch engagement | Lidmaatschap van een bestaande rechtspersoon | Oprichting van een vzw of coöperatie |
...
Het Waalse kader, vastgelegd in het decreet van 5 mei 2022 en verduidelijkt door de [CWaPE](https://www.cwape.be/secteur/communautes-partage-energie), bepaalt wie kan aansluiten. Het essentiële criterium: deelname is **vrijwillig en open**, en elk lid kan op elk moment opnieuw vertrekken.

| Profiel | Kan toetreden? | Specifieke voorwaarden |
|---|---|---|
| Particuliere eigenaar | Ja | Digitale meter; EAN binnen perimeter (CER) |
...
Kmo's en zelfstandigen kunnen toetreden tot een CER of CEC, **op voorwaarde dat energie niet hun hoofdactiviteit is** (producenten, leveranciers en handelaren zijn in de regel uitgesloten). Het criterium is opgenomen in het standaardformulier dat de CWaPE gebruikt voor de melding (zie de [CWaPE-procedure](https://www.cwape.be/node/6052)).
...
| Rang | Kanaal | Doelgroep | Inspanning |
|---|---|---|---|
| 1 | OptimCE openbaar register | Burgers, kmo's — snel zoeken per gemeente | Laag — webbrowsing |
| 2 | SPW-facilitator Energiegemeenschappen | Burger die persoonlijke begeleiding wil | Gemiddeld — contactname |
| 3 | Énergie commune (matching) | Burger gericht op coöperatie / waarden | Laag — online formulier |
| 4 | Lokale intercommunale / coöperatie | Inwoners van een afgebakende zone | Variabel |
| 5 | DNB-pagina's (ORES, RESA, AIEG) | Bevestiging na identificatie | Laag |
| 6 | Gemeente, lokale pers, mond-tot-mond | Toevallige ontdekking | Variabel |
...
Verschillende intercommunales animeren hun eigen deeldynamiek. De [AIEG](https://www.aieg.be/le-partage-denergie), bijvoorbeeld, coördineert actief het energiedelen in de gemeenten Andenne, Éghezée en Gesves. Burgercoöperaties (Courant d'Air, Énergie 2030, Lucéole, en anderen) dragen eveneens deelprojecten in hun werkgebied — een blik op hun website is vaak de moeite waard.

### Informatiepagina's van de netbeheerders

ORES, RESA en AIEG publiceren informatie over de actieve gemeenschappen op hun grondgebied. Zij doen geen rechtstreekse matching, maar laten toe om het bestaan van een project — al via een ander kanaal geïdentificeerd — te bevestigen.
...
Naargelang de juridische structuur van de gemeenschap variëren de formaliteiten:

- **Vzw**: lidkaart, typisch een symbolische jaarlijkse bijdrage van €10 tot €50.
- **Coöperatie**: inschrijving op één of meer aandelen, doorgaans €25 tot €500. **De aandelen zijn terugvorderbaar** bij vertrek, onder de in de statuten bepaalde voorwaarden (vaak een terugbetalingstermijn).
- **Intercommunale of andere vorm**: specifieke modaliteiten meegedeeld door de beheerder.
...
De **interne prijs** ligt typisch tussen €0,12 en €0,20/kWh, tegenover €0,30 tot €0,40/kWh op de markt. Verifieer de **indexatieclausule** (gekoppeld aan het markttarief, vast gedurende 12 maanden, herzienbaar op AV…) en de **transparantie** van het proces: wie bepaalt de prijs, met welke frequentie, hoe wordt hij gecommuniceerd aan de leden?
...
Als de productie van de gemeenschap op een bepaald moment het verbruik van de leden overschrijdt, wordt het **niet-gedeelde overschot** in het net geïnjecteerd en **doorverkocht via de leverancier van de producent** tegen het geldende terugleveringstarief. Er is in Wallonië geen systematische afregeling.

## FAQ — Toetreden tot een energiegemeenschap in Wallonië

### Hoeveel kost het om toe te treden?

Het hangt af van de structuur. Een **vzw** vraagt doorgaans een bijdrage van €10 tot €50 per jaar. Een **coöperatie** vraagt de inschrijving op één of meer aandelen, meestal tussen €25 en €500 — terugvorderbaar bij vertrek. De CWaPE legt geen administratieve vergoeding op voor de aansluiting van een lid.
...
- [CWaPE — Energiegemeenschappen en energiedelen](https://www.cwape.be/secteur/communautes-partage-energie) — Waals kader van toetredingsvoorwaarden en delen.
- [CWaPE — Procedure om een energiegemeenschap op te richten](https://www.cwape.be/node/6052) — standaardformulier, lijst van toegelaten leden, melding.
- [SPW Énergie — Energiegemeenschappen en energiedelen](https://energie.wallonie.be) — rol van de facilitator en officiële vulgarisatie.
- [Énergie commune — Gemeenschap](https://energiecommune.be) — matchingformulier voor burgers op zoek naar een Waalse gemeenschap.
- [Énergie+ — Hoe een energiegemeenschap opzetten in Wallonië](https://energieplus-lesite.be/webinaire/comment-mettre-en-place-une-communaute-denergie-en-wallonie/) — logica van aansluiting en deelname.
- [AIEG — Het energiedelen](https://www.aieg.be/le-partage-denergie) — lokale operationele voorbeelden en technische vereisten aan netzijde.
