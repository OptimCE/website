---
layout: post
title: "Solar surplus: the 5 options compared"
date: 2026-08-18 04:00:00 +0200
author: "Eric from OptimCE"
excerpt: "A 4 kWp installation generates around 3,800 kWh a year, and nearly 2,400 of them leave the house with nobody to use them. Five options exist to do something about it: export them, heat your water, charge the car, store them in a battery, share them. They are nowhere near equivalent — the spread runs from 1 to 37 cents per kilowatt-hour, and from 0 to 12,000 euros of investment. Here is the calculation item by item, across all three regions, and the order in which to stack them."
description: "Export, water tank, car, battery or sharing: what a kilowatt-hour of solar surplus is really worth in Belgium, and the order in which to absorb it."
...
> ### Make more of your solar surplus with OptimCE
>
> An open-source platform built for Belgian energy communities: members, meters, allocation keys and sharing operations in one place — right through to simulating how much is genuinely shareable quarter-hour by quarter-hour, and invoicing the energy transferred.
>
...
- [CWaPE — Periodic electricity distribution tariffs, low-voltage offtake, ORES ASSETS, period 01.01.2026 to 31.12.2026](https://www.cwape.be/sites/default/files/cwape-documents/ORES%20-%20Tarifs%20p%C3%A9riodiques%20de%20pr%C3%A9l%C3%A8vement%202026_0.pdf) — primary source for the capacity-based prosumer tariff of €80.9813336/kWe, the residential capacity term set at €0/kW for 2026-2029, the Impact tariff bands and the 80 % reduction of the proportional term on energy shared within the same building. Approved 18 December 2025.
- [CWaPE — The prosumer tariff](https://www.cwape.be/node/148) — nature of the tariff, default application to prosumers without a dual-flow or smart meter, exemption for protected customers.
- [SPW Économie — Solar PV: understanding the prosumer tariff](https://economie.wallonie.be/fr/demandes/2949_photovoltaique-s-informer-sur-le-tarif-prosumer.html) — official self-consumption assumption of 37.76 %, distinction between the capacity-based and proportional calculations, and the cap of the proportional at the capacity-based amount. Updated 27 May 2026.
- [ORES — Solar installations commissioned before 1 January 2024](https://www.ores.be/particulier/compensation-avant-0101) — annual compensation maintained until 31 December 2030 and automatic application of the more favourable tariff formula.
- [ORES — Solar installation commissioned from 1 January 2024](https://www.ores.be/particulier/prosumer-a-partir-de-2024) — end of compensation, mandatory smart meter, separate measurement of offtake and injection, absence of a prosumer tariff and the need for an injection contract.
- [ORES — Impact, a new tariff for flexible consumers](https://www.ores.be/comprendre-ma-facture/impact) — the three ECO, MEDIUM and PIC time bands, access conditions and strictly optional nature.
- [CWaPE — Press release: 2026 changes to distribution tariffs for all users of the Walloon low-voltage grid](https://www.cwape.be/documents-recents/communique-de-presse-changements-en-2026-au-niveau-des-tarifs-de-distribution) — new off-peak band from 11 a.m. to 5 p.m. and from 10 p.m. to 7 a.m., seven days a week, since 1 January 2026.
- [Test-Achats — How to find the best injection tariff for your solar surplus](https://www.test-achats.be/maison-energie/energie-renouvelable/news/cout-energie-solaire-injectee) — survey of 28 May 2026: 0.94 to 4.90 c€/kWh in Flanders and Wallonia, 1.40 to 4.81 c€/kWh in Brussels, the largely variable nature of these rates and the primacy of the consumption rate when choosing a contract.
- [Énergie+ — Domestic hot water consumption](https://energieplus-lesite.be/theories/eau-chaude-sanitaire12/consommation-d-eau-chaude-sanitaire/) — reference of 35 to 40 litres at 60 °C per person per day, used to size the volume of surplus a tank can absorb.
- [Fluvius — Digital meter FAQ](https://www.fluvius.be/nl/veelgestelde-vragen/digitale-meter) — end of automatic compensation of a spinning-back meter balance for any switch to the digital meter since 1 April 2026.
- [Vlaamse Nutsregulator — Capaciteitstarief](https://www.vlaamsenutsregulator.be/elektriciteit-en-aardgas/nettarieven/capaciteitstarief) — calculation on the average of the last twelve monthly quarter-hourly peaks, 2.5 kW floor and average cost of about €53.39 per kW per year excluding VAT for 2026.
- [Vlaamse Nutsregulator — Energy sharing and energy selling](https://www.vlaamsenutsregulator.be/elektriciteit-en-aardgas/energieprijzen-en-facturen/energiedelen-en-energie-verkopen) — the forms of sharing and selling allowed in Flanders, the digital meter and quarter-hourly metering requirements, and the restriction to the Flemish Region.
- [Fluvius — What does energy sharing bring?](https://www.fluvius.be/nl/groene-energie/energiedelen/wat-brengt-het-op) — sharing and person-to-person selling affect only the energy component; network charges, levies and taxes remain due, and some suppliers charge an annual fee per access point.
- [Brugel — Energy Sharing FAQ](https://energysharing.brugel.brussels/blog/energy-sharing-18/faq-539) — declaration of any sharing to Sibelga, Brugel authorisation reserved for energy communities, proximity tariff types A to D and the reduction of the exit notice to 24 hours on 1 January 2026.
- [Brussels Environment — Solar panels: new green certificate measures in 2026](https://environnement.brussels/citoyen/news/2025/panneaux-photovoltaiques-nouvelles-mesures-en-2026-pour-les-certificats-verts) — award coefficients applying to installations commissioned since 1 April 2026 and the RESCert PV certificate requirement since 1 January 2026.
- [CWaPE — Energy sharing](https://www.cwape.be/node/5618) — definition of sharing, the same-quarter-hour rule, freedom to choose an allocation key and the CWaPE's authorisation role.
- [SPW Énergie — Energy communities and sharing within the same building](https://energie.wallonie.be/home/les-marches-et-les-acteurs/communautes-d-energie/communautes-d-energie-et-partage-d-energie-au-sein-d-un-meme-batiment-electricite.html) — forms of sharing recognised in Wallonia, the requirement for a remotely read quarter-hourly dual-flow meter and the fact that network charges and levies remain due on shared electricity.
- [SPW Logement — The Primes Habitation, temporary support regime 14/02/2025 to 30/09/2026](https://logement.wallonie.be/fr/aide/primes-habitation-2025) — application deadline and the role of the prior housing audit.
- [Renolution — the Brussels renovation portal](https://renolution.brussels/fr) — absence of any government decision on new forms of financial support for renovation in Brussels.
- [Vlaanderen — Mijn VerbouwPremie](https://www.vlaanderen.be/mijn-verbouwpremie) — reform of the scheme on 1 March 2026, with its main effect on owner-occupiers in the two highest income categories.
- [CREG — Household energy prices, April 2026 findings](https://www.creg.be/fr/actualites/prix-de-lenergie-pour-les-menages-constatations-avril-2026) — the weight of the energy component in the total electricity bill, used to estimate the marginal saving of a kilowatt-hour absorbed rather than exported.
