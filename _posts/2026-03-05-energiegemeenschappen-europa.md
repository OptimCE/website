...
Datzelfde besluit, gewijzigd door het [besluit van 21 februari 2025](https://www.legifrance.gouv.fr/jorf/id/JORFTEXT000051292744), trok het plafond voor **gecumuleerd vermogen op van 3 naar 5 MW** op het continentale vasteland — 0,5 MW in de niet-verbonden gebieden.

De uitrol valt rechtstreeks bij de bron te volgen: Enedis publiceert als **open data** het aantal actieve operaties, hun productievermogen en het aantal deelnemende producenten en verbruikers, elk kwartaal bijgewerkt ([Enedis Open Data](https://opendata.enedis.fr/datasets/autoconsommation-collective-maille-enedis)).

### Nederland — de Energiewet en het rechtstreeks delen

In Nederland is het kader het meest recent verschoven. De **Energiewet is op 1 januari 2026 in werking getreden** en verving de Elektriciteitswet 1998 en de Gaswet. Ze definieert de *energiegemeenschap* en maakt het **rechtstreeks delen van energie** tussen leden juridisch mogelijk ([wetten.overheid.nl](https://wetten.overheid.nl/BWBR0050714/2026-01-01)).

De contractuele constructie die daaruit volgt lijkt sterk op de Belgische. Toezichthouder ACM wijst erop dat een deelnemer **meerdere contracten** nodig heeft: een contract voor het energiedelen, een leveringscontract voor de momenten waarop de gedeelde energie niet volstaat, en een teruglevercontract voor opgewekte maar niet verbruikte elektriciteit. Voor het bestuur is één punt cruciaal: de ACM **houdt toezicht op de tarieven van de leverancier** voor levering en teruglevering, **maar niet op de prijzen die in het deelcontract zijn afgesproken** ([ACM](https://www.acm.nl/nl/publicaties/acm-energiedelen-biedt-kansen-voor-energiegemeenschappen-en-appartementencomplexen-die-duurzame-energie-opwekken)).

De economische hefboom blijft de **SCE** (*Subsidieregeling Coöperatieve Energieopwekking*), die in 2021 de vroegere postcoderoosregeling verving en een exploitatiesubsidie per kWh uitkeert over een gewaarborgde looptijd van 15 jaar, verankerd in een **nabijheidslogica op basis van postcodes** ([RVO](https://www.rvo.nl/subsidies-financiering/sce)).
...
<div class="post-cta" markdown="0">
  <h3>Beheer uw energiegemeenschap met OptimCE</h3>
  <p>Leden, meters, verdeelsleutels en regelgevende rapportering: OptimCE is een opensource-platform gebouwd voor nationale kaders die uiteenlopen. Doorblader de open deelacties of richt uw eigen gemeenschap op.</p>
...
- [Richtlijn (EU) 2018/2001 (RED II) — EUR-Lex](https://eur-lex.europa.eu/eli/dir/2018/2001/oj/eng) — definitie van de hernieuwbare-energiegemeenschap en verplichtingen van de lidstaten.
- [Richtlijn (EU) 2019/944 over de interne elektriciteitsmarkt — EUR-Lex](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32019L0944) — definitie en kadering van de burgerenergiegemeenschap.
- [Europese Commissie — Energy Communities](https://social-economy-gateway.ec.europa.eu/topics-focus/energy-communities_en) — overzicht van beide vormen en wat ze delen.
- [Légifrance — besluit van 21 november 2019 over het criterium van geografische nabijheid, artikel 1](https://www.legifrance.gouv.fr/loda/article_lc/LEGIARTI000051294683) — perimeter van 2 km, laagspanningsaansluiting bij dezelfde netbeheerder, drempels van 5 MW en 0,5 MW.
- [Légifrance — besluit van 21 februari 2025](https://www.legifrance.gouv.fr/jorf/id/JORFTEXT000051292744) — optrekking van het plafond voor gecumuleerd vermogen van 3 naar 5 MW.
- [Enedis Open Data — actieve operaties collectief zelfverbruik](https://opendata.enedis.fr/datasets/autoconsommation-collective-maille-enedis) — officiële telling, elk kwartaal bijgewerkt.
- [Energiewet — wetten.overheid.nl](https://wetten.overheid.nl/BWBR0050714/2026-01-01) — tekst zoals in werking sinds 1 januari 2026.
- [ACM — Energiedelen biedt kansen voor energiegemeenschappen](https://www.acm.nl/nl/publicaties/acm-energiedelen-biedt-kansen-voor-energiegemeenschappen-en-appartementencomplexen-die-duurzame-energie-opwekken) — vereiste contracten en de grenzen van het toezicht.
- [RVO — Subsidieregeling Coöperatieve Energieopwekking (SCE)](https://www.rvo.nl/subsidies-financiering/sce) — Nederlandse steunregeling voor energiecoöperaties.
