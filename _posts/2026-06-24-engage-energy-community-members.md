...
faq:
  - q: "What's the difference between a news post and a poll?"
    a: "A news post (or publication) is top-down information: the manager informs members — meetings, maintenance, sharing results, deadlines. A poll is participatory: it asks a question and collects members' votes to inform or make a collective decision."
  - q: "Are poll votes anonymous?"
    a: "It depends on the chosen setting. OptimCE offers three modes: Anonymous (nobody sees who voted for what), Transparent (everyone sees the per-voter breakdown) and On close (results revealed when the poll closes). The manager can also fine-tune visibility on the manager side and on the member side."
  - q: "Who can publish a news post or create a poll?"
    a: "The community's managers (administrators). Members read the news, receive notifications and vote in polls."
  - q: "Are members notified when something is published?"
    a: "Yes. Every new post or poll triggers a notification to members, so they can react and vote without missing anything."
  - q: "Can a poll be used to decide on an allocation key?"
    a: "Yes, that's a typical use. A change of allocation key affects everyone's bill: putting it to a vote, with a clear closing date, legitimises the decision and strengthens member buy-in."
  - q: "Do you need a dedicated tool to run an energy community?"
    a: "It isn't mandatory, but a news board and polls built into the management platform avoid scattering information across emails and chat groups, and keep a clear record of information and decisions. OptimCE includes both."
---
...
An energy community isn't just another supplier: it's a group of people — individuals, tenants, SMEs, local authorities — who decide to produce and share electricity together. The European framework is explicit on this. According to the directives that define them (Directive [(EU) 2018/2001](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32018L0001) for renewable energy communities and Directive [(EU) 2019/944](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32019L0944) for citizen energy communities), these structures are based on **voluntary, open participation**, are **effectively controlled by their members**, and exist primarily for environmental, economic and social community benefits — not financial profit ([European Commission](https://energy.ec.europa.eu/topics/markets-and-consumers/energy-consumers-and-prosumers/energy-communities_en)).

In other words, without member participation an energy community loses its reason to exist. It's also the model championed by [REScoop.eu](https://www.rescoop.eu/the-rescoop-model), the European federation of citizen energy cooperatives, which brings together around **2,500 communities** and **2 million citizens** around the principle of "**one member, one vote**" and the international cooperative principles. Engagement isn't a nice-to-have, then; it's what sets a community apart from a plain commercial offer.
...
> **[Creating an energy community in Wallonia: a step-by-step guide](/en/news/2026/05/11/create-energy-community-wallonia/)**
>
> From choosing the type of community to starting sharing with your grid operator.

> **[Joining an energy community in Wallonia: a practical guide](/en/news/2026/05/11/join-energy-community-wallonia/)**
>
> Who can join, where to find an open operation and the steps involved.

<div class="post-cta" markdown="0">
  <h3>Ready to bring your community to life? Start with OptimCE</h3>
  <p>OptimCE, the open-source energy community management platform, brings together in one place member management, allocation keys, grid-operator reporting — and now a news board and polls to inform and involve your members.</p>
...
- [European Commission — Energy communities](https://energy.ec.europa.eu/topics/markets-and-consumers/energy-consumers-and-prosumers/energy-communities_en) — definitions, voluntary participation and effective control by members, social purpose.
- [Directive (EU) 2018/2001 (RED II)](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32018L0001) — definition of the renewable energy community.
- [Directive (EU) 2019/944](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32019L0944) — definition of the citizen energy community and effective control by members.
- [REScoop.eu — The REScoop Model](https://www.rescoop.eu/the-rescoop-model) — democratic "one member, one vote" governance and cooperative principles.
- [Énergie Commune](https://www.energiecommune.be) — support for energy communities in Belgium.
