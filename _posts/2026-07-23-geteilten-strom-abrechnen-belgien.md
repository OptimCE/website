...
Das ist das grundlegende Missverständnis. Die Teilnahme an einer Energieteilung **kündigt Ihren Liefervertrag nicht**: Das Teilen deckt nur einen Teil Ihres Verbrauchs ab, den Ihnen der Aufteilungsschlüssel viertelstundenweise zuweist. Der Rest — die Restenergie — kommt weiterhin aus dem Netz und wird weiterhin von Ihrem Lieferanten abgerechnet.
...
- **6 %** für die Lieferung von Strom an einen **privaten Kunden**;
...
Über die MwSt. hinaus trägt die Rechnung des Vertreters zwei Abgaben, welche die CWaPE ausdrücklich zu den auf geteilten Strom geschuldeten Elementen zählt: die **Akzisen** und die **ÖDV zur Rückgabe der Quoten grüner Zertifikate** ([CWaPE](https://www.cwape.be/node/6063)). Sie kommen zum Energiepreis hinzu, geteilte kWh für geteilte kWh.
...
1. **Eine Vereinbarung**, die den Vertreter benennt und die Abrechnungsmodalitäten, den Aufteilungsschlüssel und den Preis der geteilten Energie festlegt.
...
### Wie rechnet man geteilten Strom in einem Gebäude in Belgien ab?
...
- [CWaPE — Wer stellt geteilten Strom in Rechnung?](https://www.cwape.be/node/6059) — der Vertreter der Energieteilung fakturiert, auf der Grundlage der Daten des Netzbetreibers und des Aufteilungsschlüssels; Inhalt der Rechnung (Energie, MwSt., Akzisen, ÖDV grüne Zertifikate).
- [CWaPE — Wie hoch sind die Kosten des geteilten Stroms?](https://www.cwape.be/node/6063) — zusätzlich zum Energiepreis fakturierte Elemente: MwSt., Akzisen und ÖDV zur Rückgabe der Quoten grüner Zertifikate.
- [CWaPE — Netzentgelte auf geteilten Strom](https://www.cwape.be/node/6062) — auf die geteilten kWh geschuldete Netzentgelte; Ermäßigung von 80 % beschränkt auf das Teilen innerhalb eines einzigen Gebäudes.
