---
layout: post
title: "Geteilte Elektrizität in Belgien abrechnen: Wer stellt was in Rechnung, MwSt. und Pflichten"
...
faq:
  ...
  - q: "Wie rechnet man geteilte Elektrizität in einem Gebäude in Belgien ab?"
  ...
  - q: "Welcher MwSt.-Satz gilt für geteilte Elektrizität?"
...
Bei der Energieteilung trägt ein Akteur — und nur einer — die Verantwortung für die Abrechnung: der **Vertreter der Energieteilung**. Die CWaPE lässt keine Zweideutigkeit: Es ist der Vertreter der Energieteilung, der die geteilte Energie den Teilnehmern in Rechnung stellt ([CWaPE](https://www.cwape.be/node/6059)). Es handelt sich um die Person oder die Struktur, die in der Teilungsvereinbarung benannt wird, um den Vorgang zu organisieren und die administrative Nachverfolgung sicherzustellen.

Der Punkt, der Projektträger am meisten überrascht: **Der Netzbetreiber stellt keine Rechnung.** Er berechnet die Teilung viertelstundenweise, wendet den gewählten Verteilungsschlüssel an und übermittelt dann die Mengen den verschiedenen Akteuren „um die Abrechnung zu ermöglichen“. Die Rechnung selbst wird anschließend „auf der Grundlage der vom Netzbetreiber erhaltenen Verbrauchsdaten unter Berücksichtigung des gewählten Verteilungsschlüssels“ erstellt ([CWaPE](https://www.cwape.be/node/6059)). Mit anderen Worten: Das Netz liefert die Zahlen, der Vertreter macht daraus Dokumente.
...
Über die MwSt. hinaus trägt die Rechnung des Vertreters zwei Abgaben, welche die CWaPE ausdrücklich zu den auf geteilte Elektrizität geschuldeten Elementen zählt: die **Akzisen** und die **ÖDV zur Rückgabe der Quoten grüner Zertifikate** ([CWaPE](https://www.cwape.be/node/6063)). Sie kommen zum Energiepreis hinzu, geteilte kWh für geteilte kWh.

Zwei Vorsichtsmaßnahmen vermeiden hier häufige Fehler:

- **Der föderale Beitrag existiert nicht mehr.** Er wurde am 31. Dezember 2021 abgeschafft und in die besondere Akzise überführt ([CREG](https://www.creg.be/fr/a-z-index/cotisation-federale)). Viele noch kursierende Rechnungsvorlagen und Simulatoren erwähnen ihn: Übernehmen Sie ihn nicht.
...
Eine Regel verdient es, hervorgehoben zu werden, weil sie Einsteiger zu Fall bringt: **Eine ausgestellte Rechnung wird nie bearbeitet.** Ein Fehler bei einer Menge, einem Preis oder einem Empfänger wird nicht durch erneutes Öffnen des Dokuments korrigiert — man stellt eine **Gutschrift** aus, die sie storniert, und fakturiert sauber neu. Die Historie bleibt intakt und überprüfbar, was genau das ist, wonach man Sie am Tag einer Prüfung oder eines Einspruchs fragen wird. Der für Vertreter von Energieteilungen veröffentlichte Abrechnungsleitfaden beschreibt diese Dokumentenkette ([ORES / Federia](https://media.ores.be/ores-cms/vi2eqxam/ores_guide_explicatif_facturation_representant_partage_energie_fr.pdf)).
...
Genau das übernimmt das [Abrechnungsmodul von OptimCE](/de/aktuelles/2026/07/16/energiegemeinschaft-abrechnung-optimce/), verfügbar seit Juli 2026. Sie legen Ihre Preise fest, Sie wählen einen Zeitraum, und OptimCE erstellt die Dokumente aller Mitglieder aus den bereits in die Plattform importierten **offiziellen Aufteilungsdaten** — ohne erneute Eingabe und ohne Zwischentabelle.
...
>
> Open-Source-Plattform für belgische Energiegemeinschaften: Importieren Sie Ihre Aufteilungsdaten, definieren Sie Ihre Preise, erzeugen Sie Rechnungen, Gutschriften und Abrechnungen als PDF — mit gesetzlicher Nummerierung, strukturierter Mitteilung und Zahlungsverfolgung.
>
...
- [CWaPE — Wer stellt geteilte Elektrizität in Rechnung?](https://www.cwape.be/node/6059) — der Vertreter der Energieteilung fakturiert, auf der Grundlage der Daten des Netzbetreibers und des Verteilungsschlüssels; Inhalt der Rechnung (Energie, MwSt., Akzisen, ÖDV grüne Zertifikate).
- [CWaPE — Wie hoch sind die Kosten der geteilten Elektrizität?](https://www.cwape.be/node/6063) — zusätzlich zum Energiepreis fakturierte Elemente: MwSt., Akzisen und ÖDV zur Rückgabe der Quoten grüner Zertifikate.
- [CWaPE — Netzentgelte auf geteilte Elektrizität](https://www.cwape.be/node/6062) — auf die geteilten kWh geschuldete Netzentgelte; Ermäßigung von 80 % beschränkt auf das Teilen innerhalb eines einzigen Gebäudes.
- [CWaPE — Mögliche Gebühren des Lieferanten](https://www.cwape.be/node/6060) — der Lieferant kann Gebühren im Zusammenhang mit der Teilnahme am Teilen fakturieren.
- [Sibelga — Die Grundsätze der Energieteilung](https://www.sibelga.be/fr/raccordements-compteurs/energie-renouvelable/partage-energie/les-principes-du-partage-denergie) — Rollen der Akteure (Erzeuger, Vertreter, Lieferant, Netzbetreiber) und Datenfluss.
