...
### Wallonia: legal on paper, almost non-existent in practice
...
- [Brugel — Network tariffs applicable to energy sharing](https://energysharing.brugel.brussels/energysharing/tarifs-de-reseau-409) — source for the four perimeters A, B, C and D and the treatment of each tariff term, from decision 285bis of 4 November 2024 applicable from 1 January 2025 to 31 December 2029; also states the rule classifying a mixed sharing operation on its least local participant, and the free meter replacement for participants.
- [Brugel — Authorised communities](https://energysharing.brugel.brussels/energysharing/les-communautes-autorisees-586) — named and dated list of energy communities authorised in the Brussels-Capital Region, from “Illuminons notre quartier” on 16 May 2023 to the authorisations of 29 May 2026; 38 communities in total as consulted on 5 August 2026.
- [Brugel — New statistical set on energy sharing in Brussels](https://brugel.brussels/actualites/nouveau-set-statistique-sur-le-partage-d-energie-a-bruxelles-661) — presentation of the regional observatory: number of projects, participants and shared installed capacity, with a municipality-by-municipality map.
- [Renouvelle — Energy sharing in Brussels: more than 1,000 participants!](https://www.renouvelle.be/fr/partage-denergie-a-bruxelles-plus-de-1000-participants/) — survey of 16 October 2024: 1,009 participants, 129 projects and 6.63 MWp shared since 2022, against 397 participants the previous year, with the breakdown by form of sharing (same building 72 projects / 533 participants, peer-to-peer 47 / 94, communities 10 / 382).
- [La DH — Energy sharing between users has almost tripled in a year in Brussels](https://www.dhnet.be/regions/bruxelles/2025/06/29/le-partage-denergie-entre-usagers-a-presque-triple-en-un-an-a-bruxelles-FRCFU2ZFOZDIBNL725OQOJACPM/) — Sibelga count of 29 June 2025, distinct from Brugel's: 1,280 participants in 2024 against 454 in 2023, on 93,702 smart meters installed.
- [Renouvelle — Energy sharing and communities in Wallonia: the CWaPE's opinion](https://www.renouvelle.be/fr/partage-et-communautes-energie-en-wallonie-avis-de-la-cwape/) — assessment of 18 March 2025: 4 same-building sharing operations and 3 within a community, six obstacles identified, and the regulator's conclusion that the objectives of the European directives are not being met.
- [CWaPE — Energy sharing](https://www.cwape.be/node/5618) — Walloon framework: definition of sharing, available forms (same building and community), appointment of a representative, agreement with the network operator and admissible allocation keys.
- [CWaPE — Conditions for taking part in energy sharing](https://www.cwape.be/node/6078) — conditions applying to Walloon consumers: communicating electronic or AMR meter, waiver of the benefit of compensation, and waiver of the social tariff on the shared electricity portion for residential customers.
- [BeProsumer — Action plan on the blockages to sharing in Wallonia](https://www.beprosumer.be/2026/06/23/beprosumer-transforme-les-denonciations-davril-en-plan-daction-formel/) — file of 23 June 2026 sent to the Walloon energy minister and the CWaPE, source of the wording “provided for by decree since 2022 but still inoperative for lack of an implementing order”. An association defending small Walloon photovoltaic producers: a stakeholder, not a neutral source.
- [Bruxelles Environnement — Energy sharing and communities](https://environnement.brussels/citoyen/agir-pour-lenvironnement/devenir-eco-responsable/partage-et-communautes-denergie) — Brussels citizen portal: the three sharing configurations and the free “Energy Sharing and Communities” facilitator.
- [Bruxelles Environnement — Energy sharing has never been so simple](https://environnement.brussels/citoyen/news/2026/le-partage-denergie-na-jamais-ete-aussi-simple) — announcement of 2 June 2026 of the BEST platform (Brussels Energy Sharing Tool), developed by the non-profit Simply Energy with support from Bruxelles Environnement.
- [Sibelga — Energy sharing](https://www.sibelga.be/en/connections-meters/renewable-energy/energy-sharing) — operational workings on the Brussels network operator's side: the three forms of sharing, the smart meter requirement for every participant and the analysis of meter readings in fifteen-minute intervals.
- [VREG — “Energy shared and sold” dashboard](https://www.vlaamsenutsregulator.be/cijfers/dashboard-energie-delen-en-verkopen) — Fluvius data updated monthly (latest update recorded: 27 July 2026) on the number of groups and participants, shared volumes, and suppliers charging extra fees to participants.
- [Futech — How many Flemish people take part in energy sharing?](https://futech.be/hoeveel-vlamingen-doen-aan-energiedelen/) — relay of VREG and Fluvius figures: 7,779 access points taking part in sharing or selling in December 2023, i.e. 0.2 % of Flemish access points, and around 20 % of injection effectively shared against 40 % expected.
- [CREG — Monthly dashboard](https://www.creg.be/fr/professionnels/fonctionnement-et-monitoring-du-marche/tableau-de-bord) — all-in price of 36.94 c€/kWh and the 38.5 / 29.7 / 26.1 / 5.7 % split for a residential profile of 3,500 kWh/year on a single-rate meter (June 2026 edition used here).
- [Énergie Commune / Interreg Europe — Business model of energy sharing](https://www.interregeurope.eu/sites/default/files/good_practices/8.%20EnergieCommune_EC_BM_Sharing_Interreg_Ghent.pdf) — documented case costing the saving of a consumer receiving 500 kWh shared per year at around €145 at the standard tariff, against around €70 for a household already on the social tariff.
- [CWaPE — ORES, periodic offtake tariffs 2026](https://www.cwape.be/sites/default/files/cwape-documents/ORES%20-%20Tarifs%20p%C3%A9riodiques%20de%20pr%C3%A9l%C3%A8vement%202026_0.pdf) — grid approved on 18 December 2025, source of the 80 % reduction of the proportional term reserved for sharing within a single building.
