...
faq:
  ...
  - q: "Wie erhöhe ich meinen Eigenverbrauch ohne Batterie?"
    a: "Indem Sie Ihren Verbrauch in die Sonnenstunden verlagern: Waschmaschine, Geschirrspüler und Trockner tagsüber laufen lassen, Warmwasser mittags erhitzen, das E-Auto nachmittags laden. Das Teilen von Energie in einer Gemeinschaft erlaubt zudem, den Überschuss zu verwerten, den Sie nicht selbst verbrauchen können."
  - q: "Was ist der Unterschied zwischen individuellem und kollektivem Eigenverbrauch?"
    a: "Individueller Eigenverbrauch bedeutet, die eigene Produktion vor Ort zu verbrauchen. Kollektiver Eigenverbrauch verteilt die Produktion einer oder mehrerer Anlagen auf mehrere Teilnehmer (ein Gebäude, ein Viertel) über das öffentliche Netz, auf administrativer Basis."
  - q: "Brauche ich Solarmodule für den kollektiven Eigenverbrauch?"
    a: "Nein. In einer Teilungsoperation können Sie reiner Verbraucher sein und einen Anteil der von anderen Mitgliedern erzeugten Energie erhalten — ohne Anlage und ohne Investition."
  - q: "Muss ich meinen Stromlieferanten wechseln?"
    a: "Nein. Sie behalten Ihren Lieferanten, der nur noch die Restenergie abrechnet — den Teil Ihres Verbrauchs, der nicht durch Ihre eigene Produktion oder das Teilen gedeckt ist."
  - q: "Funktioniert kollektiver Eigenverbrauch überall in Belgien?"
    a: "Der Rahmen besteht in allen drei Regionen, jedoch mit unterschiedlichen Modalitäten: Die Wallonie (CWaPE, ORES/RESA/AIEG) und Flandern (VREG, Fluvius) haben einen operativen Rahmen, während Brüssel (BRUGEL, Sibelga) den kollektiven Eigenverbrauch über Pilotprojekte eingeführt hat. Ein intelligenter Zähler ist überall erforderlich."
---

Der Eigenverbrauch ist zu einer der Säulen der belgischen Energiewende geworden: den lokal erzeugten Strom selbst verbrauchen, statt ihn zu geringem Wert ins Netz einzuspeisen. Mit einem Photovoltaik-Bestand von inzwischen über **8 GWp** und seit 2022 volatilen Marktpreisen war es noch nie so sinnvoll, die eigene Produktion zu verwerten — allein oder gemeinsam. Dieser Artikel erklärt, was Eigenverbrauch ist, warum er sich lohnt, wie Sie Ihre **Eigenverbrauchsquote** erhöhen und wie er mit **Energiegemeinschaften** zusammenhängt — mit den Unterschieden zwischen Wallonie, Brüssel und Flandern.

## Was ist Eigenverbrauch?

Eigenverbrauch bedeutet, den **selbst erzeugten Strom** — typischerweise über Solarmodule — in dem Moment zu verbrauchen, in dem er produziert wird, statt ihn ins Netz einzuspeisen. Es gibt zwei Formen.
...
Eine Anlage produziert nur tagsüber, doch ein großer Teil des Haushaltsverbrauchs fällt morgens und abends an. Die Eigenverbrauchsquote zu erhöhen heißt, **Verbrauch und Produktion näher zusammenzubringen**. Mehrere Hebel ergänzen sich:

1. **Verbrauch in den Tag verlagern.** Waschmaschine, Geschirrspüler und Trockner in den Sonnenstunden zu programmieren, ist der günstigste und unmittelbarste Hebel.
2. **Den Warmwasserspeicher steuern.** Warmwasser mittags zu erhitzen, verwandelt den Solarüberschuss in gespeicherte Wärme — eine kostenlose „thermische Batterie“.
...
Kollektiver Eigenverbrauch geschieht nicht „von Hand“ unter Nachbarn: Er stützt sich auf eine **Rechtsstruktur** — die Energiegemeinschaft — und auf eine beim VNB angemeldete **Teilungsoperation**.
...
Das Prinzip des Eigenverbrauchs ist überall gleich, doch die Akteure und der Reifegrad des Rahmens unterscheiden sich von Region zu Region.
...
| Rahmen für kollektiven Eigenverbrauch | Operativ (CER / CEC) | Über Pilotprojekte eingeführt | Operativ („energiedelen“) |
| Intelligenter Zähler erforderlich | Ja | Ja | Ja |
| Zusatzeinkommen für den Erzeuger | Grünstromzertifikate | Grünstromzertifikate (≈ erste 10 Jahre) | Spezifische Förderung — siehe VREG |

- **Wallonie.** Die [CWaPE](https://www.cwape.be/documents-recents/autoconsommation-collective-et-reseaux-alternatifs-avis-sur-un-projet-de-decret) reguliert den kollektiven Eigenverbrauch und alternative Netze; [ORES](https://www.ores.be/particulier/communautes-denergie) und die anderen VNB verwalten Zähler und Verteilung. Der wallonische Rahmen für [kollektiven Eigenverbrauch und Energiegemeinschaften](https://energie.wallonie.be/home/actualites/actualites/communautes-denergie-et-autocons.html) ist heute stabilisiert.
- **Brüssel.** [BRUGEL](https://brugel.brussels/actualites/lancement-du-1er-projet-d-autoconsommation-collective-a-bruxelles-415) hat das **erste Projekt für kollektiven Eigenverbrauch** der Region gestartet, technisch betrieben von Sibelga. Das [Energy-Sharing-Portal von BRUGEL](https://energysharing.brugel.brussels/energysharing/les-projets-405) listet die Projekte, und [Renouvelle](https://www.renouvelle.be/fr/premiers-projets-pilotes-dautoconsommation-collective-a-bruxelles/) beschreibt den Nutzen dieser Pilotprojekte für die Viertel.
- **Flandern.** Das Energieteilen („**energiedelen**“) wird vom VREG reguliert und von [Fluvius](https://www.fluvius.be/nl/groene-energie/energiedelen) betrieben, das die technischen Bedingungen, den Verkauf von Grünstrom und das Teilen zwischen Teilnehmern erläutert.

## Wer profitiert?

- **Anlagenbesitzer**, die den Wert ihrer Produktion durch eine höhere Eigenverbrauchsquote maximieren.
- **Prosumer mit Überschuss**: Sie verwerten ihn bei anderen Mitgliedern, statt ihn zu niedrigem Preis einzuspeisen.
...
Es ist der Anteil Ihrer Solarproduktion, den Sie selbst verbrauchen, statt ihn ins Netz einzuspeisen. Eine Quote von 30 % bedeutet, dass Sie 30 % der Erzeugung Ihrer Anlage direkt verbrauchen; der Rest wird eingespeist. Je höher die Quote, desto mehr Wert schöpfen Sie aus Ihrer Produktion.

### Wie erhöhe ich meinen Eigenverbrauch ohne Batterie?

Indem Sie Ihren Verbrauch in die Sonnenstunden verlagern: Waschmaschine, Geschirrspüler und Trockner tagsüber laufen lassen, Warmwasser mittags erhitzen, das E-Auto nachmittags laden. Das Teilen von Energie in einer Gemeinschaft erlaubt zudem, den Überschuss zu verwerten, den Sie nicht selbst verbrauchen können.

### Was ist der Unterschied zwischen individuellem und kollektivem Eigenverbrauch?

Individueller Eigenverbrauch bedeutet, die eigene Produktion vor Ort zu verbrauchen. Kollektiver Eigenverbrauch verteilt die Produktion einer oder mehrerer Anlagen auf mehrere Teilnehmer (ein Gebäude, ein Viertel) über das öffentliche Netz, auf administrativer Basis.

### Brauche ich Solarmodule für den kollektiven Eigenverbrauch?

Nein. In einer Teilungsoperation können Sie reiner Verbraucher sein und einen Anteil der von anderen Mitgliedern erzeugten Energie erhalten — ohne Anlage und ohne Investition.

### Muss ich meinen Stromlieferanten wechseln?

Nein. Sie behalten Ihren Lieferanten, der nur noch die Restenergie abrechnet — den Teil Ihres Verbrauchs, der nicht durch Ihre eigene Produktion oder das Teilen gedeckt ist.

### Funktioniert kollektiver Eigenverbrauch überall in Belgien?

Der Rahmen besteht in allen drei Regionen, jedoch mit unterschiedlichen Modalitäten: Die Wallonie (CWaPE, ORES/RESA/AIEG) und Flandern (VREG, Fluvius) haben einen operativen Rahmen, während Brüssel (BRUGEL, Sibelga) den kollektiven Eigenverbrauch über Pilotprojekte eingeführt hat. Ein intelligenter Zähler ist überall erforderlich.
...
- [Énergie Wallonie — Energiegemeinschaften und kollektiver Eigenverbrauch](https://energie.wallonie.be/home/actualites/actualites/communautes-denergie-et-autocons.html) — wallonischer Rahmen und Bezug zu den EU-Richtlinien.
- [ORES — Energiegemeinschaften](https://www.ores.be/particulier/communautes-denergie) — CER und CEC, Teilnahmebedingungen in der Wallonie.
- [CWaPE — Kollektiver Eigenverbrauch und alternative Netze](https://www.cwape.be/documents-recents/autoconsommation-collective-et-reseaux-alternatifs-avis-sur-un-projet-de-decret) — rechtlicher Rahmen und regulatorische Entwicklung.
- [BRUGEL — Start des 1. Projekts für kollektiven Eigenverbrauch in Brüssel](https://brugel.brussels/actualites/lancement-du-1er-projet-d-autoconsommation-collective-a-bruxelles-415) — Brüsseler Rahmen und Pilotprojekte.
- [BRUGEL Energy Sharing — Die Projekte](https://energysharing.brugel.brussels/energysharing/les-projets-405) — Portal der Energieteilungs-Projekte in Brüssel.
- [Renouvelle — Erste Pilotprojekte für kollektiven Eigenverbrauch in Brüssel](https://www.renouvelle.be/fr/premiers-projets-pilotes-dautoconsommation-collective-a-bruxelles/) — konkrete Projekte und Nutzen für das Viertel.
- [Fluvius — Energiedelen en verkopen van groene stroom](https://www.fluvius.be/nl/groene-energie/energiedelen) — Energieteilen und technische Bedingungen in Flandern.
- [Beci — Energiegemeinschaften für den kollektiven Eigenverbrauch](https://www.beci.be/blog/esg-34/les-communautes-denergie-pour-lautoconsommation-collective-2086) — wirtschaftlicher und praktischer Blickwinkel für Belgien.
