...
In der Wallonie bestehen zwei Modelle nebeneinander, beide reguliert von der [CWaPE](https://www.cwape.be/secteur/communautes-partage-energie), der wallonischen Energieregulierungsbehörde: die **Erneuerbare-Energie-Gemeinschaft (CER)** und die **Bürger-Energiegemeinschaft (CEC)**. Die Wahl bestimmt den weiteren Verlauf: zulässige Energiequellen, geografischer Umfang, Aktivitätsarten.
...
Für eine vertiefte Lektüre stellt die Referenzseite der CWaPE den [wallonischen Rahmen, die Gemeinschaftstypen und die rechtlichen Grundlagen](https://www.cwape.be/node/158) aus dem wallonischen Dekret vom 5. Mai 2022 und dem Erlass der wallonischen Regierung vom 17. März 2023 dar.

## Schritt 2 — Das Projekt strukturieren und einen Vertreter benennen

Dies ist der längste Schritt, aber auch derjenige, der die Belastbarkeit der Gemeinschaft bestimmt. Vor jeder Einreichung bei der CWaPE müssen Sie das Projekt **strukturieren**, indem Sie die vier von [MaCER / Cluster TWEED](https://macer.clustertweed.be/etapes) hervorgehobenen Schlüsselfragen beantworten:
...
Die CWaPE verfügt nach Einreichung Ihrer Meldung über **10 Werktage**, um Ihnen eine **Empfangsbestätigung** zukommen zu lassen (Quelle: [CWaPE — Verfahren](https://www.cwape.be/node/6052)). Diese Frist ist kurz, aber strikt: **Sie dürfen die Energieteilung nicht starten, bevor Sie diese Bestätigung erhalten haben.**
...
- [CWaPE — Welches Verfahren ist zur Gründung einer Energiegemeinschaft zu befolgen?](https://www.cwape.be/node/6052) — verpflichtende Meldung, Standardformular, 10-Werktage-Frist für die Empfangsbestätigung.
- [CWaPE — Energiegemeinschaften](https://www.cwape.be/node/158) — wallonischer Rahmen, Gemeinschaftstypen, Rechtsgrundlagen, Meldung und Jahresberichterstattung.
- [CWaPE — Energiegemeinschaften und Energieteilung](https://www.cwape.be/secteur/communautes-partage-energie) — allgemeiner wallonischer Rahmen für Teilung und Gemeinschaften.
- [ORES — Eine Energiegemeinschaft starten (CER/CEC)](https://www.ores.be/particulier/demarrer-partage-cer-cec) — Vorgehen auf Seiten des Verteilnetzbetreibers.
- [AIEG — Die Energieteilung](https://www.aieg.be/le-partage-denergie) — operative Aspekte und VNB-seitige Inbetriebnahme.
- [MaCER / Cluster TWEED — Die Schlüsselschritte](https://macer.clustertweed.be/etapes) — Begleitung zur Strukturierung eines Energiegemeinschaftsprojekts.
- [Énergie+ — Regulierung: Energiegemeinschaften in der Wallonie](https://energieplus-lesite.be/reglementations/electricite-et-production-energetique/reglementation-les-communautes-denergie-en-wallonie/) — wallonischer Regulierungsrahmen verständlich erklärt.
- [Énergie+ — Wie eine Energiegemeinschaft in der Wallonie aufgesetzt wird?](https://energieplus-lesite.be/webinaire/comment-mettre-en-place-une-communaute-denergie-en-wallonie/) — Gründungsschritte erläutert.
