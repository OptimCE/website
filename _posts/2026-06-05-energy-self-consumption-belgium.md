---
layout: post
title: "Energy self-consumption in Belgium: individual, collective and energy communities"
...
faq:
  ...
  - q: "How can I raise my self-consumption without a battery?"
    a: "By shifting your usage to sunny hours: running the washing machine, dishwasher and dryer during the day, heating domestic hot water at midday, charging the EV in the afternoon. Sharing energy within a community also lets you monetise the surplus you can't consume yourself."
  - q: "What is the difference between individual and collective self-consumption?"
    a: "Individual self-consumption means consuming your own production on site. Collective self-consumption shares the production of one or more installations among several participants (a building, a neighbourhood) over the public grid, on an administrative basis."
  - q: "Do I need to own solar panels for collective self-consumption?"
    a: "No. In a sharing operation you can be a plain consumer and receive a share of the energy produced by other members, with no installation and no investment."
  - q: "Do I need to change electricity supplier?"
    a: "No. You keep your supplier, who keeps billing only the residual energy — the part of your consumption not covered by your own production or by sharing."
  - q: "Does collective self-consumption work everywhere in Belgium?"
    a: "The framework exists in all three regions but with different terms: Wallonia (CWaPE, ORES/RESA/AIEG) and Flanders (VREG, Fluvius) have an operational framework, while Brussels (BRUGEL, Sibelga) has rolled out collective self-consumption through pilot projects. A smart meter is required everywhere."
---
...
> For the full legal framework (CER, CEC, CEL) and how sharing works in detail, see our reference guide [“Energy communities in Belgium: CER, CEC and CEL explained”](/en/news/2026/05/11/energy-communities-belgium/).
...
The choice of allocation key determines what share of production each member receives in each quarter-hour, and therefore the real impact of collective self-consumption on each bill. We detail the keys accepted in each region in [“Allocation key in Belgium: Wallonia, Brussels and Flanders compared”](/en/news/2026/05/19/allocation-key-belgium/).
...
- **Wallonia.** The [CWaPE](https://www.cwape.be/documents-recents/autoconsommation-collective-et-reseaux-alternatifs-avis-sur-un-projet-de-decret) regulates collective self-consumption and alternative networks; [ORES](https://www.ores.be/particulier/communautes-denergie) and the other DSOs handle metering and allocation. The Walloon framework for [collective self-consumption and energy communities](https://energie.wallonie.be/home/actualites/actualites/communautes-denergie-et-autocons.html) is now stabilised.
- **Brussels.** [BRUGEL](https://brugel.brussels/actualites/lancement-du-1er-projet-d-autoconsommation-collective-a-bruxelles-415) launched the Region's **first collective self-consumption project**, operated technically by Sibelga. BRUGEL's [Energy Sharing portal](https://energysharing.brugel.brussels/energysharing/les-projets-405) lists the projects, and [Renouvelle](https://www.renouvelle.be/fr/premiers-projets-pilotes-dautoconsommation-collective-a-bruxelles/) describes why these pilots matter for neighbourhoods.
- **Flanders.** Energy sharing ("**energiedelen**") is regulated by the VREG and operated by [Fluvius](https://www.fluvius.be/nl/groene-energie/energiedelen), which details the technical conditions, the sale of green electricity, and sharing between participants.
...
<div class="post-cta" markdown="0">
  <h3>Ready to put your production to use? Start with OptimCE</h3>
  <p>Browse the public registry of open energy communities near you, reach out to the one that fits, or create your own. OptimCE — an open-source platform — then automates member management, allocation keys and reporting to your network operator.</p>
...
- [Énergie Wallonie — Energy communities and collective self-consumption](https://energie.wallonie.be/home/actualites/actualites/communautes-denergie-et-autocons.html) — Walloon framework and link with the EU directives.
- [ORES — Energy communities](https://www.ores.be/particulier/communautes-denergie) — CER and CEC, conditions for participation in Wallonia.
- [CWaPE — Collective self-consumption and alternative networks](https://www.cwape.be/documents-recents/autoconsommation-collective-et-reseaux-alternatifs-avis-sur-un-projet-de-decret) — legal framework and regulatory evolution.
- [BRUGEL — Launch of the 1st collective self-consumption project in Brussels](https://brugel.brussels/actualites/lancement-du-1er-projet-d-autoconsommation-collective-a-bruxelles-415) — Brussels framework and pilot projects.
- [BRUGEL Energy Sharing — The projects](https://energysharing.brugel.brussels/energysharing/les-projets-405) — portal of energy-sharing projects in Brussels.
- [Renouvelle — First collective self-consumption pilots in Brussels](https://www.renouvelle.be/fr/premiers-projets-pilotes-dautoconsommation-collective-a-bruxelles/) — concrete projects and neighbourhood value.
- [Fluvius — Energiedelen en verkopen van groene stroom](https://www.fluvius.be/nl/groene-energie/energiedelen) — energy sharing and technical conditions in Flanders.
- [Beci — Energy communities for collective self-consumption](https://www.beci.be/blog/esg-34/les-communautes-denergie-pour-lautoconsommation-collective-2086) — economic and practical angle for Belgium.
