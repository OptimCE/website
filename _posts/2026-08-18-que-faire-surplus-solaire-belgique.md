---
layout: post
title: "Surplus solaire : les 5 options comparées"
date: 2026-08-18 04:00:00 +0200
author: "Eric d'OptimCE"
excerpt: "Une installation de 4 kWc produit environ 3 800 kWh par an, et près de 2 400 sortent de la maison sans que personne ne les consomme. Cinq options existent pour en faire quelque chose : les injecter, chauffer l'eau sanitaire, recharger la voiture, les stocker en batterie, les partager. Elles ne se valent pas du tout — l'écart va de 1 à 37 centimes le kilowattheure, et de 0 à 12 000 euros d'investissement. Voici le calcul poste par poste, pour les trois régions, et l'ordre dans lequel les empiler."
description: "Injecter, boiler, voiture, batterie, partage : ce que vaut vraiment un kilowattheure de surplus solaire en Belgique, et dans quel ordre l'absorber."
...
### Wallonie, installation mise en service avant le 1<sup>er</sup> janvier 2024
...
### Wallonie, installation mise en service depuis le 1<sup>er</sup> janvier 2024
...
La compensation pure et simple est abolie depuis 2021 et il n'existe pas de tarif prosumer bruxellois. En revanche, la Région maintient les **certificats verts**, ce qui la distingue nettement des deux autres. Depuis le 1<sup>er</sup> avril 2026, le taux d'octroi reste inchangé pour les installations résidentielles jusqu'à 5 kWc, recule de 11 % de 5 à 36 kWc, de 45 % de 36 à 100 kWc, et disparaît au-delà de 100 kWc. Depuis le 1<sup>er</sup> janvier 2026, toute nouvelle installation d'au plus 5 kWc doit obtenir un certificat RESCert PV pour y accéder.
...
Le compteur numérique a mis fin au compteur qui tourne à l'envers, et le prosumententarief disparaît avec lui : vous ne payez plus de frais de réseau que sur ce que vous prélevez réellement. Fluvius a par ailleurs fixé une échéance nette : **depuis le 1<sup>er</sup> avril 2026, le solde accumulé sur un compteur qui tourne à l'envers n'est plus compensé automatiquement** lors du passage au compteur numérique.
...
| **Bruxelles** | partage en bâtiment, entre bâtiments, communauté d'énergie | déclaration à Sibelga pour tout partage, autorisation de Brugel pour les communautés uniquement, tarifs de proximité de type A à D, préavis de sortie ramené à 24 heures depuis le 1<sup>er</sup> janvier 2026 |
...
> ### Valorisez votre surplus solaire avec OptimCE
>
> Plateforme open source pensée pour les communautés d'énergie belges : membres, compteurs, clés de répartition et opérations de partage au même endroit — jusqu'à la simulation du volume réellement partageable au quart d'heure et à la facturation de l'énergie cédée.
>
...
- [CWaPE — Tarifs périodiques de distribution d'électricité, prélèvement basse tension, ORES ASSETS, période du 01.01.2026 au 31.12.2026](https://www.cwape.be/sites/default/files/cwape-documents/ORES%20-%20Tarifs%20p%C3%A9riodiques%20de%20pr%C3%A9l%C3%A8vement%202026_0.pdf) — source primaire du tarif prosumer capacitaire à 80,9813336 €/kWe, du terme capacitaire résidentiel fixé à 0 €/kW pour 2026-2029, des bandes du tarif Impact et de la réduction de 80 % du terme proportionnel sur l'énergie partagée au sein d'un même bâtiment. Approuvé le 18 décembre 2025.
- [CWaPE — Le tarif prosumer](https://www.cwape.be/node/148) — nature du tarif, application par défaut aux prosumers dépourvus de compteur double flux ou intelligent, exonération des clients protégés.
- [SPW Économie — Photovoltaïque : s'informer sur le tarif prosumer](https://economie.wallonie.be/fr/demandes/2949_photovoltaique-s-informer-sur-le-tarif-prosumer.html) — hypothèse officielle d'autoconsommation de 37,76 %, distinction entre calcul capacitaire et calcul proportionnel, plafonnement du proportionnel au montant capacitaire. Mise à jour du 27 mai 2026.
- [ORES — Installations photovoltaïques mises en service avant le 1er janvier 2024](https://www.ores.be/particulier/compensation-avant-0101) — maintien de la compensation annuelle jusqu'au 31 décembre 2030 et application automatique de la formule tarifaire la plus avantageuse.
- [ORES — Installation photovoltaïque mise en service à partir du 1er janvier 2024](https://www.ores.be/particulier/prosumer-a-partir-de-2024) — fin de la compensation, obligation du compteur communicant, mesure séparée du prélèvement et de l'injection, absence de tarif prosumer et nécessité d'un contrat d'injection.
- [ORES — Impact, un nouveau tarif pour les consommateurs flexibles](https://www.ores.be/comprendre-ma-facture/impact) — trois bandes horaires ECO, MEDIUM et PIC, conditions d'accès et caractère strictement optionnel.
- [CWaPE — Communiqué : changements en 2026 au niveau des tarifs de distribution pour l'ensemble des utilisateurs du réseau électrique basse tension wallon](https://www.cwape.be/documents-recents/communique-de-presse-changements-en-2026-au-niveau-des-tarifs-de-distribution) — nouvelle plage d'heures creuses de 11h à 17h et de 22h à 7h, 7 jours sur 7, depuis le 1er janvier 2026.
- [Test-Achats — Comment trouver le meilleur tarif d'injection pour votre surplus d'électricité d'origine solaire ?](https://www.test-achats.be/maison-energie/energie-renouvelable/news/cout-energie-solaire-injectee) — relevé du 28 mai 2026 : de 0,94 à 4,90 c€/kWh en Flandre et en Wallonie, de 1,40 à 4,81 c€/kWh à Bruxelles, caractère majoritairement variable des tarifs et prééminence du tarif de consommation dans le choix d'un contrat.
- [Énergie+ — Consommation d'eau chaude sanitaire](https://energieplus-lesite.be/theories/eau-chaude-sanitaire12/consommation-d-eau-chaude-sanitaire/) — référence de 35 à 40 litres à 60 °C par personne et par jour, utilisée pour dimensionner le volume de surplus absorbable par un ballon.
- [Fluvius — Veelgestelde vragen over de digitale meter](https://www.fluvius.be/nl/veelgestelde-vragen/digitale-meter) — fin de la compensation automatique du solde d'un compteur qui tourne à l'envers pour tout passage au compteur numérique depuis le 1er avril 2026.
- [Vlaamse Nutsregulator — Capaciteitstarief](https://www.vlaamsenutsregulator.be/elektriciteit-en-aardgas/nettarieven/capaciteitstarief) — calcul sur la moyenne des douze dernières pointes mensuelles quart-horaires, plancher de 2,5 kW et coût moyen d'environ 53,39 €/kW par an hors TVA pour 2026.
- [Vlaamse Nutsregulator — Energiedelen en energie verkopen](https://www.vlaamsenutsregulator.be/elektriciteit-en-aardgas/energieprijzen-en-facturen/energiedelen-en-energie-verkopen) — formes de partage et de vente autorisées en Flandre, obligation du compteur numérique et du régime de mesure quart-horaire, limitation à la Région flamande.
- [Fluvius — Wat brengt energiedelen op ?](https://www.fluvius.be/nl/groene-energie/energiedelen/wat-brengt-het-op) — le partage et la vente de personne à personne n'agissent que sur la composante énergie ; les frais de réseau, prélèvements et taxes restent dus, et certains fournisseurs facturent un forfait annuel par point d'accès.
- [Brugel — Energy Sharing, foire aux questions](https://energysharing.brugel.brussels/blog/energy-sharing-18/faq-539) — déclaration de tout partage à Sibelga, autorisation Brugel réservée aux communautés d'énergie, types de proximité tarifaire A à D et réduction du préavis de sortie à 24 heures au 1er janvier 2026.
- [Bruxelles Environnement — Panneaux photovoltaïques : nouvelles mesures en 2026 pour les certificats verts](https://environnement.brussels/citoyen/news/2025/panneaux-photovoltaiques-nouvelles-mesures-en-2026-pour-les-certificats-verts) — coefficients d'octroi applicables aux installations mises en service depuis le 1er avril 2026 et obligation du certificat RESCert PV depuis le 1er janvier 2026.
- [CWaPE — Partage d'énergie](https://www.cwape.be/node/5618) — définition du partage, règle du même quart d'heure, liberté de choix de la clé de répartition et rôle d'autorisation de la CWaPE.
- [SPW Énergie — Communautés d'énergie et partage d'énergie au sein d'un même bâtiment](https://energie.wallonie.be/home/les-marches-et-les-acteurs/communautes-d-energie/communautes-d-energie-et-partage-d-energie-au-sein-d-un-meme-batiment-electricite.html) — formes de partage reconnues en Wallonie, obligation du compteur double flux télé-relevé quart-horaire et maintien des frais de réseau et taxes sur l'électricité partagée.
- [SPW Logement — Les primes Habitation, régime de soutien temporaire du 14/02/2025 au 30/09/2026](https://logement.wallonie.be/fr/aide/primes-habitation-2025) — date limite d'introduction des demandes et rôle de l'audit logement préalable.
- [Renolution — portail bruxellois de la rénovation](https://renolution.brussels/fr) — absence de décision gouvernementale sur de nouvelles formes de soutien financier à la rénovation à Bruxelles.
- [Vlaanderen — Mijn VerbouwPremie](https://www.vlaanderen.be/mijn-verbouwpremie) — réforme du dispositif au 1er mars 2026, avec un effet principal sur les propriétaires occupants des deux catégories de revenus les plus élevées.
- [CREG — Prix de l'énergie pour les ménages, constatations avril 2026](https://www.creg.be/fr/actualites/prix-de-lenergie-pour-les-menages-constatations-avril-2026) — poids de la composante énergie dans la facture totale d'électricité, utilisé pour estimer l'économie marginale d'un kilowattheure absorbé plutôt qu'injecté.
