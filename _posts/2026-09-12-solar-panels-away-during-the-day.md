...
description: "85.8% of your output arrives while the house is empty. What really shifts when nobody is there, measured, and where the ceiling sits."
...
faq:
  ...
  - q: "Does the off-peak change of 1 January 2026 help me if I have panels?"
    a: "Yes, but less than the way it is usually presented. Since 1 January 2026 Walloon off-peak hours run from 11:00 to 17:00 and from 22:00 to 07:00, seven days a week. Computing the hourly output of a typical system across four years of European Commission data, the share of production now falling inside an off-peak window rises from 28.8% to 71.4%: the ratio has been exactly reversed. This genuinely matters for two populations. For a prosumer under compensation, midday output is now set against the off-peak register, and therefore against night-time consumption — a car charging at 23:00, for instance. For everyone else, the kilowatt-hour you still have to buy at midday costs 5.55 c€ less in distribution than at peak hours. But keep the proportions in view: that 5.55 c€/kWh gain is six times smaller than the 33.44 c€ that self-consuming the kilowatt-hour is worth. The reform makes the right move a little more rewarding; it does not replace it. And it has a downside: the weekend, which used to be entirely off-peak, loses 18 off-peak hours."
  - q: "What does running the dishwasher and washing machine at midday actually change?"
    a: "Far less than you are promised. This is the one point in the file on which Belgian field measurement exists: Test-Achats followed 34 households with solar panels between October 2018 and October 2019 as part of a European project. The result: running the large appliances mainly during the day raises self-consumption by 3% on average, around 126 kWh shifted over the year. Applied to our reference case, that is worth roughly 38 € a year. It is not nothing, it is free, and you should do it — but it is the weakest lever in the file, while being the one most often recommended. The reason is arithmetic: a dishwasher cycle uses less than one kilowatt-hour, a 30 °C wash cycle about 0.6 kWh, while a 4 kilowatt-peak system produces more than 10 kWh between 11:00 and 17:00 on an average June day. Two cycles do not absorb 15% of what the roof puts out over that window. The tumble dryer, which would be the largest of the three, is precisely the one you cannot schedule: somebody has to move the laundry."
  - q: "Why is my hot-water tank the best lever, and what should I do about it?"
    a: "Because it is the only appliance in the house whose consumption is at once large, daily, fully shiftable in time and completely indifferent to whether you are there. In the same Test-Achats study, controlling the electric water heater produces an average 13% rise in self-consumption, 660 kWh a year — more than four times the appliance gain. The obstacle is physical rather than financial: across much of the Walloon housing stock, the tank is not wired to the ordinary circuit. It hangs off a day/night contactor, or off an exclusive-night meter that only closes between 22:00 and 07:00, sometimes 21:00 and 06:00 depending on the substation. That wiring was rational for forty years. It no longer is: ORES writes that since 1 January 2026 the distribution rates for the exclusive-night meter and for dual-rate off-peak hours are aligned, and that there is therefore no specific advantage in keeping that meter if your main tariff is the dual-rate one. In other words, the best surplus absorber in your house is wired to a time signal that no longer pays. The fix is to move the tank circuit onto the main meter, then control it over the production window, keeping a regular rise to 60 °C against legionella."
  - q: "Do I need a home battery if I am away all day?"
    a: "That is the intuitive answer, and it is almost always the wrong one. A battery does move energy from midday to the evening, which matches the profile of an absent household exactly. But it does so at a cost that is not recovered within the equipment's life. On the reference case used across our articles, a battery lifts the self-consumption rate from about 37.76% to about 75%, meaning 1,415 extra kilowatt-hours self-consumed and roughly 473 € a year net of the export revenue forgone on those kilowatt-hours. For an outlay of 7,000 to 8,000 €, payback approaches fifteen years — longer than the usual warranty. No Belgian region grants a residential battery subsidy in 2026. The rational order is therefore the reverse: control the tank first, then the car if it is at home, then share the remainder — three levers costing between nothing and a few hundred euros — and only then consider a battery, or treat it as a resilience purchase, which is a different question from profitability."
  - q: "Does energy sharing work when you are never at home?"
    a: "It is the only lever in the file that asks nothing of you, and that is precisely why it suits an absent household. All the others assume you shift a consumption; sharing instead borrows somebody else's — a neighbour working from home, a school, a shop, a local authority — whose load curve is full at the moment yours is flat. It settles quarter-hour by quarter-hour: only electricity produced, injected and consumed within the same quarter-hour can be shared. Two important caveats in Wallonia. First the perimeter: sharing between two neighbours who are neither in the same building nor in an energy community — peer-to-peer — has been provided for by decree since 2022 but still lacks its implementing order, so it is inoperative. The two routes genuinely open are sharing within a single building, which carries an 80% reduction on the proportional grid-tariff term, and the energy community, which carries no tariff reduction at all. Then the order of magnitude: on the exported remainder of a household that has already put its tank under control, sharing at 6 to 10 c€/kWh instead of 3.5 c€ is worth roughly 44 to 114 € a year. It is real, it is free, and it is no miracle."
---
...
This article does not redo what is already written elsewhere on this site. [“Solar surplus: the 5 options compared”](/en/news/2026/08/18/what-to-do-solar-surplus-belgium/) ranks the five possible destinations for surplus by euro invested; [“Solar panels 2026: still worth it in Wallonia?”](/en/news/2026/08/11/solar-panels-worth-it-wallonia-2026/) covers profitability and the divide between pre- and post-2024 installations; [“Reduce your electricity bill: Wallonia 2026”](/en/news/2026/07/28/reduce-electricity-bill-wallonia-2026/) sets out the new tariff grid and the Impact tariff; [“Energy self-consumption in Belgium”](/en/news/2026/06/05/energy-self-consumption-belgium/) lays down the definitions; [“Local electricity: the short-circuit guide”](/en/news/2026/08/25/local-electricity-short-circuit-guide/) explains how to build a group by overlaying load profiles; [“Join an energy community in Wallonia”](/en/news/2026/05/11/join-energy-community-wallonia/) describes the administrative route.
...
<img src="/assets/images/diagrams/away-daytime-profile-en.svg"
...
> Peak hours: from 7h to 11h and from 17h to 22h, Monday to Sunday
> Off-peak hours: from 11h to 17h and from 22h to 7h, Monday to Sunday
...
**Moving to a dynamic contract because you have panels.** This is the costliest misreading. We flagged it in [“Which electricity tariff to choose in Belgium?”](/en/news/2026/08/03/choose-electricity-tariff-belgium/): **99% of households with panels paid more under dynamic pricing**, with a median rise of 20%, precisely because their surplus arrives when market prices collapse.
...
- [European Commission, Joint Research Centre — PVGIS 5.3](https://re.jrc.ec.europa.eu/pvg_tools/en/) — the source of every hourly-distribution percentage in this article. Hourly series computed for Namur (50.4674; 4.8718), SARAH3 radiation database, years 2020 to 2023, 4 kWp, 35° tilt, 0° azimuth, 14% system losses, then each UTC hour converted to Belgian local time with daylight-saving changes applied. Accessed on 12 September 2026.
- [CWaPE — ORES Assets, periodic electricity distribution tariffs, low-voltage withdrawal 2026](https://www.cwape.be/sites/default/files/cwape-documents/ORES%20-%20Tarifs%20p%C3%A9riodiques%20de%20pr%C3%A9l%C3%A8vement%202026_0.pdf) — primary source for the time windows and the amounts: peak hours from 7h to 11h and from 17h to 22h, off-peak hours from 11h to 17h and from 22h to 7h, Monday to Sunday; Impact bands PIC 17h-22h, MEDIUM 7h-11h and 22h-1h, ECO 11h-17h and 1h-7h; dual-rate proportional term of 0.1042868 and 0.0487574 €/kWh excluding VAT; 80% reduction on the proportional term for energy shared within a single building, aggregation codes E216 and E526. Approved on 18 December 2025, valid from 1 January to 31 December 2026. Accessed on 12 September 2026.
- [ORES — The dual-rate tariff changes its schedule](https://www.ores.be/comprendre-ma-facture/bihoraire) — confirmation of the new windows, alignment of the weekend on the weekday regime, and the count of 105 off-peak hours a week against 93 in 2025. Accessed on 12 September 2026.
- [ORES — Everything about the exclusive-night meter](https://www.ores.be/comprendre-ma-facture/exclusif-de-nuit) — the source for the hot-water-tank section: alignment of the distribution rates for the exclusive-night meter and dual-rate off-peak hours since 1 January 2026, disappearance of the specific advantage for dual-rate customers, windows of 22:00–07:00 or 21:00–06:00 depending on the substation, and the recommendation to regroup onto the main meter to increase self-consumption. Accessed on 12 September 2026.
- [ORES — Impact, a new tariff for flexible consumers](https://www.ores.be/comprendre-ma-facture/impact) — the three ECO, MEDIUM and PIC bands, their windows, access conditions, and the fact that keeping compensation depends on the supplier's commercial offer. Accessed on 12 September 2026.
- [Wallonia portal — On 1 January 2026, the dual-rate tariff changes its schedule](https://www.wallonie.be/fr/actualites/le-1er-janvier-2026-le-bihoraire-change-dhoraire) — the official rationale for moving the off-peak hours: to encourage consumption at the moments when renewable electricity supply is most abundant. Published on 31 October 2025, accessed on 13 September 2026.
- [CWaPE — Energy sharing](https://www.cwape.be/node/5618) — definition of sharing as the distribution of energy injected and consumed within the same quarter-hour, and the exhaustive listing of the two open routes: a group of active customers within a single building, or participants in an energy community. Source for the statement that peer-to-peer remains inoperative in Wallonia. Accessed on 12 September 2026.
- [Test-Achats — How to increase self-consumption of photovoltaic electricity?](https://www.test-achats.be/maison-energie/energie-renouvelable/dossier/augmenter-autoconsommation-production-photovoltaique) — field study on 34 households with panels between October 2018 and October 2019, as part of a European project. Source of the measured gains: 3% for appliances shifted into the day, that is 126 kWh, 13% for a controlled electric water heater, that is 660 kWh, 10 to 40% for an electric car on a 10 kWp system, 28% to 44% with a 5 kWh battery, no gain for electric heating. Also the source of the finding that the highest rates occur in households where somebody stays at home during the day. Article updated on 24 July 2025, accessed on 13 September 2026.
- [Test-Achats — How to find the best export tariff for your surplus solar electricity?](https://www.test-achats.be/maison-energie/energie-renouvelable/news/cout-energie-solaire-injectee) — reading of 28 May 2026: from 0.94 to 4.90 c€/kWh in Flanders and Wallonia, and the predominantly variable nature of these tariffs. Source of the 3.5 c€/kWh export value used in all our calculations. Accessed on 12 September 2026.
- [SPW Économie — Photovoltaics: information on the prosumer tariff](https://economie.wallonie.be/fr/demandes/2949_photovoltaique-s-informer-sur-le-tarif-prosumer.html) — the official self-consumption assumption of 37.76% used as the basis for computing the prosumer tariff, and the distinction between capacity-based and proportional calculation. Updated on 27 May 2026, accessed on 13 September 2026.
- [ORES — Photovoltaic systems commissioned before 1 January 2024](https://www.ores.be/particulier/compensation-avant-0101) — retention of annual compensation until 31 December 2030 for systems certified before that date, and automatic application of the most favourable tariff formula. Accessed on 12 September 2026.
- [CWaPE — Energy communities and energy sharing](https://www.cwape.be/taxonomy/term/865) — the applicable framework, model agreements, freedom to choose the allocation key applied by the grid operator, and the absence of any tariff reduction for sharing within an energy community. Accessed on 12 September 2026.
- [Union of Walloon Cities and Municipalities — CWaPE report on the evaluation of the framework for energy communities, energy sharing and self-consumption](https://www.uvcw.be/energie/actus/art-9454) — the finding of development held back by a combination of legal, administrative and economic obstacles, and the absence of an independent facilitator for project holders. Report of February 2025, accessed on 13 September 2026.
- [CREG — Energy price dashboard](https://www.creg.be/fr/professionnels/fonctionnement-et-monitoring-du-marche/tableau-de-bord) — the source of the all-in retail price of 36.94 c€/kWh including VAT used across all our articles since the June 2026 reading. Accessed on 12 September 2026.
- [SPW Énergie — Incentive pricing](https://energie.wallonie.be/home/au-quotidien/a-la-maison/gerer-ses-appareils-electriques/tarification.html) — the official Walloon position on shifting consumption: favour the solar hours or the night-time troughs for energy-hungry appliances, and consume photovoltaic output at the moment it is generated. Accessed on 12 September 2026.
