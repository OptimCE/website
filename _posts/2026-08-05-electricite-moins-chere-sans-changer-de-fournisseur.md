...
La décision Brugel 285bis du 4 novembre 2024, applicable du 1<sup>er</sup> janvier 2025 au 31 décembre 2029, définit **quatre périmètres** selon la proximité électrique des participants :
...
- [Brugel — Tarifs de réseau applicables au partage d'énergie](https://energysharing.brugel.brussels/energysharing/tarifs-de-reseau-409) — source des quatre périmètres A, B, C et D et du traitement de chaque terme tarifaire, issus de la décision 285bis du 4 novembre 2024 applicable du 1<sup>er</sup> janvier 2025 au 31 décembre 2029 ; mentionne également la règle de classement d'un partage mixte sur le participant le moins local et la gratuité du remplacement du compteur pour les participants.
- [Brugel — Les communautés autorisées](https://energysharing.brugel.brussels/energysharing/les-communautes-autorisees-586) — liste nominative et datée des communautés d'énergie autorisées en Région bruxelloise, de « Illuminons notre quartier » le 16 mai 2023 aux autorisations du 29 mai 2026 ; total de 38 communautés à la consultation du 5 août 2026.
- [Brugel — Nouveau set statistique sur le partage d'énergie à Bruxelles](https://brugel.brussels/actualites/nouveau-set-statistique-sur-le-partage-d-energie-a-bruxelles-661) — présentation de l'observatoire régional : nombre de projets, de participants et capacité installée partagée, avec une carte commune par commune.
- [Renouvelle — Partage d'énergie à Bruxelles : plus de 1 000 participants !](https://www.renouvelle.be/fr/partage-denergie-a-bruxelles-plus-de-1000-participants/) — relevé du 16 octobre 2024 : 1 009 participants, 129 projets et 6,63 MWc partagés depuis 2022, contre 397 participants l'année précédente, avec la ventilation par forme de partage (même bâtiment 72 projets / 533 participants, pair-à-pair 47 / 94, communautés 10 / 382).
- [La DH — Le partage d'énergie entre usagers a presque triplé en un an à Bruxelles](https://www.dhnet.be/regions/bruxelles/2025/06/29/le-partage-denergie-entre-usagers-a-presque-triple-en-un-an-a-bruxelles-FRCFU2ZFOZDIBNL725OQOJACPM/) — comptage Sibelga du 29 juin 2025, distinct de celui de Brugel : 1 280 participants en 2024 contre 454 en 2023, sur 93 702 compteurs intelligents installés.
- [Renouvelle — Partage et communautés d'énergie en Wallonie : l'avis de la CWaPE](https://www.renouvelle.be/fr/partage-et-communautes-energie-en-wallonie-avis-de-la-cwape/) — évaluation du 18 mars 2025 : 4 opérations de partage en même bâtiment et 3 en communauté, six freins identifiés, et conclusion du régulateur selon laquelle les objectifs des directives européennes ne sont pas atteints.
- [CWaPE — Partage d'énergie](https://www.cwape.be/node/5618) — cadre wallon : définition du partage, formes disponibles (même bâtiment et communauté), désignation d'un représentant, convention avec le gestionnaire de réseau et clés de répartition admises.
- [CWaPE — Conditions pour participer à un partage d'énergie](https://www.cwape.be/node/6078) — conditions applicables aux consommateurs wallons : compteur électronique communicant ou AMR, renonciation au bénéfice de la compensation, et renonciation au tarif social sur la partie d'électricité partagée pour les clients résidentiels.
- [BeProsumer — Plan d'action sur les blocages du partage en Wallonie](https://www.beprosumer.be/2026/06/23/beprosumer-transforme-les-denonciations-davril-en-plan-daction-formel/) — dossier du 23 juin 2026 transmis à la ministre wallonne de l'Énergie et à la CWaPE, source de la formulation « prévu par le décret depuis 2022 mais toujours inopérant faute d'arrêté d'exécution ». Association de défense des petits producteurs photovoltaïques wallons : partie prenante, et non source neutre.
- [Bruxelles Environnement — Partage et communautés d'énergie](https://environnement.brussels/citoyen/agir-pour-lenvironnement/devenir-eco-responsable/partage-et-communautes-denergie) — portail citoyen bruxellois : les trois configurations de partage et le facilitateur « Partage et Communautés d'Énergie », gratuit.
- [Bruxelles Environnement — Le partage d'énergie n'a jamais été aussi simple](https://environnement.brussels/citoyen/news/2026/le-partage-denergie-na-jamais-ete-aussi-simple) — annonce du 2 juin 2026 de la plateforme BEST (Brussels Energy Sharing Tool), développée par l'ASBL Simply Energy avec le soutien de Bruxelles Environnement.
- [Sibelga — Partage d'énergie](https://www.sibelga.be/fr/raccordements-compteurs/energie-renouvelable/partage-energie) — fonctionnement opérationnel côté gestionnaire de réseau bruxellois : les trois formes de partage, l'obligation du compteur intelligent pour chaque participant et l'analyse des index par tranche de quinze minutes.
- [VREG — Tableau de bord « énergie partagée et vendue »](https://www.vlaamsenutsregulator.be/cijfers/dashboard-energie-delen-en-verkopen) — données Fluvius mises à jour mensuellement (dernière mise à jour relevée : 27 juillet 2026) sur le nombre de groupes et de participants, les volumes partagés et les fournisseurs facturant des frais supplémentaires aux participants.
- [Futech — Combien de Flamands pratiquent le partage d'énergie ?](https://futech.be/hoeveel-vlamingen-doen-aan-energiedelen/) — reprise des chiffres VREG et Fluvius : 7 779 points d'accès participant au partage ou à la vente en décembre 2023, soit 0,2 % des points d'accès flamands, et environ 20 % de l'injection effectivement partagée contre 40 % attendus.
